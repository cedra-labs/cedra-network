...
/// Example:
/// ```
/// use cedra_transaction_filter::UserTransactionFilterBuilder;
///
...
impl From<cedra_protos::indexer::v1::UserTransactionFilter> for UserTransactionFilter {
    fn from(proto_filter: cedra_protos::indexer::v1::UserTransactionFilter) -> Self {
        Self {
...
impl From<UserTransactionFilter> for cedra_protos::indexer::v1::UserTransactionFilter {
...
/// Example:
/// ```
/// use cedra_transaction_filter::EntryFunctionFilterBuilder;
///
...
impl From<cedra_protos::indexer::v1::EntryFunctionFilter> for EntryFunctionFilter {
    fn from(proto_filter: cedra_protos::indexer::v1::EntryFunctionFilter) -> Self {
        Self {
...
impl From<EntryFunctionFilter> for cedra_protos::indexer::v1::EntryFunctionFilter {
...
/// Example:
/// ```
/// use cedra_transaction_filter::{EntryFunctionFilterBuilder, UserTransactionPayloadFilterBuilder};
///
...
impl From<cedra_protos::indexer::v1::UserTransactionPayloadFilter>
    for UserTransactionPayloadFilter
{
    fn from(proto_filter: cedra_protos::indexer::v1::UserTransactionPayloadFilter) -> Self {
        Self {
...
impl From<UserTransactionPayloadFilter>
    for cedra_protos::indexer::v1::UserTransactionPayloadFilter
{
