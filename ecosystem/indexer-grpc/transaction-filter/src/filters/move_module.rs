...
use anyhow::anyhow;
use cedra_protos::transaction::v1::MoveStructTag;
use once_cell::sync::OnceCell;
use serde::{Deserialize, Serialize};

/// Example:
/// ```
/// use cedra_transaction_filter::MoveStructTagFilterBuilder;
///
...
impl From<cedra_protos::indexer::v1::MoveStructTagFilter> for MoveStructTagFilter {
    fn from(proto_filter: cedra_protos::indexer::v1::MoveStructTagFilter) -> Self {
        Self {
...
impl From<MoveStructTagFilter> for cedra_protos::indexer::v1::MoveStructTagFilter {
