# All processors are migrated to [processor repo](https://github.com/cedra-labs/cedra-indexer-processors)
...
## Tutorial
### Prerequisite
* A running PostgreSQL instance, with a valid database. More tutorial can be found [here](https://github.com/cedra-labs/cedra-network/tree/main/crates/indexer#postgres)
...
### Use a custom parser
* Check our [indexer processors](https://github.com/cedra-labs/cedra-indexer-processors)! 
