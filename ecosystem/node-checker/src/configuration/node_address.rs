...
use cedra_rest_client::Client as CedraRestClient;
use cedra_sdk::types::network_address::NetworkAddress;
...
impl NodeAddress {
    ...
    pub fn get_api_client(&self, timeout: Duration) -> Result<CedraRestClient> {
        ...
        Ok(CedraRestClient::from((client, self.get_api_url()?)))
    }
