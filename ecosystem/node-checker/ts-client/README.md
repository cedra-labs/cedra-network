# Generated TS client for Cedra Node Health Checker
...
## Quickstart
```bash
pnpm add cedra-node-checker-client
```
...
```
cargo run -p cedra-node-checker -- server run --baseline-node-config-paths ecosystem/node-checker/configuration_examples/local_testnet.yaml --listen-address 0.0.0.0
```
...
[npm-image-version]: https://img.shields.io/npm/v/cedra.svg
[npm-image-downloads]: https://img.shields.io/npm/dm/cedra.svg
[npm-url]: https://npmjs.org/package/cedra-node-checker-client
