...
#[derive(Clone)]
pub struct OracleNetworkClient<NetworkClient> {
    network_client: NetworkClient,
}

impl<NetworkClient: NetworkClientInterface<OracleMessage>> OracleNetworkClient<NetworkClient> {
    /// Returns a new Oracle network client
