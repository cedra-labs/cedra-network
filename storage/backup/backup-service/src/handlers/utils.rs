...
use cedra_db::{backup::backup_handler::BackupHandler, metrics::BACKUP_TIMER};
...
use cedra_storage_interface::Result as DbResult;
use hyper::Body;
...
pub(super) static LATENCY_HISTOGRAM: Lazy<HistogramVec> = Lazy::new(|| {
    register_histogram_vec!(
        "cedra_backup_service_latency_s",
...
pub(super) static THROUGHPUT_COUNTER: Lazy<IntCounterVec> = Lazy::new(|| {
    register_int_counter_vec!(
        "cedra_backup_service_sent_bytes",
