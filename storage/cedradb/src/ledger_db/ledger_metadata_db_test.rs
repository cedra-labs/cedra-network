...
use crate::{ledger_db::ledger_metadata_db::LedgerMetadataDb, CedraDB};
...
fn set_up(path: &impl AsRef<Path>, ledger_infos_with_sigs: &[LedgerInfoWithSignatures]) -> CedraDB {
    let db = CedraDB::new_for_test(path);
    ...
    ledger_infos_with_sigs
        ...
        .collect::<Result<Vec<_>, CedraDbError>>()
        .unwrap();
