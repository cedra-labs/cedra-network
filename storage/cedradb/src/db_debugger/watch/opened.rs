...
use crate::{db_debugger::ShardingConfig, CedraDB};
use cedra_config::config::StorageConfig;
...
impl Cmd {
    pub fn run(self) -> Result<()> {
        ...
        .expect("Failed to open CedraDB");

        println!("CedraDB opened. Kill to exit.");
