...
//! This module defines representation of Cedra core data structures at physical level via schemas
//! that implement [`cedra_schemadb::schema::Schema`].
//!
...
use cedra_schemadb::ColumnFamilyName;
...
#[cfg(feature = "fuzzing")]
pub mod fuzzing {
    use cedra_schemadb::schema::fuzzing::assert_no_panic_decoding;
