...
use cedra_db_indexer::{db_indexer::InternalIndexerDB, Indexer};
...
use cedra_storage_interface::{
    db_ensure as ensure, db_other_bail as bail, CedraDbError, DbReader, DbWriter, LedgerSummary,
...
/// access to the core Cedra data structures.
pub struct CedraDB {
...
include!("include/cedradb_reader.rs");
// DbWriter implementations and private functions used by them.
include!("include/cedradb_writer.rs");
// Other private methods.
include!("include/cedradb_internal.rs");
// Testonly methods.
#[cfg(any(test, feature = "fuzzing", feature = "consensus-only-perf-test"))]
include!("include/cedradb_testonly.rs");

#[cfg(feature = "consensus-only-perf-test")]
pub mod fake_cedradb;
...
impl CedraDB {
    ...
    pub fn create_checkpoint(
        ...
        info!(sharding = sharding, "Creating checkpoint for CedraDB.");
