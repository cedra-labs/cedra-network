...
use cedra_storage_interface::block_info::BlockInfo;
...
impl CedraDB {
    ...
    fn open_indexer(
        ...
        info!("CedraDB Indexer caught up.");
    ...
    fn get_raw_block_info_by_height(&self, block_height: u64) -> Result<BlockInfo> {
        if !self.skip_index_and_usage {
            ...
            Ok(self
                ...
                .ok_or_else(|| {
                    CedraDbError::NotFound(format!("BlockInfo not found at height {block_height}"))
                })?)
        }
    }
    ...
    fn get_raw_block_info_by_version(
        ...
        if !self.skip_index_and_usage {
            let (first_version, event_index, block_height) = self
                ...
                .ok_or_else(|| CedraDbError::NotFound("NewBlockEvent".to_string()))?;
    ...
    fn to_api_block_info(
        ...
        let last_version = match self.get_raw_block_info_by_height(block_height + 1) {
            ...
            Err(CedraDbError::NotFound(..)) => committed_version,
