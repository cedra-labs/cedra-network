...
//! This crate provides [`CedraDB`] which represents physical storage of the core Cedra data
//! structures.
//!
//! It relays read/write operations on the physical storage via `schemadb` to the underlying
//! Key-Value storage system, and implements cedra data structures on top of it.

pub use crate::db::CedraDB;
