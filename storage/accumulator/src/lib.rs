...
use cedra_crypto::hash::{CryptoHash, CryptoHasher, HashValue, ACCUMULATOR_PLACEHOLDER_HASH};
use cedra_types::proof::{
    ...
    H: CryptoHasher,
{
    ...
    ///
    /// See [`cedra_types::proof::AccumulatorProof`] for proof format.
    pub fn get_proof(
        reader: &R,
    ...
    ///
    /// See [`cedra_types::proof::AccumulatorConsistencyProof`] for proof format.
    ...
    ///
    /// See [`cedra_types::proof::AccumulatorRangeProof`] for proof format.
