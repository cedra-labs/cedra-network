...
def main(gas_per_ns):
    path = Path('cedra-move/cedra-gas-schedule/src/gas_schedule/cedra_framework.rs')
...
if __name__=='__main__':
    parser = argparse.ArgumentParser(
        description='Generate gas parameters for bulletproofs batch verification in `cedra-move/cedra-gas-schedule/src/gas_schedule/cedra_framework.rs`.')
