...
def main(gas_per_ns):
    path = Path('cedra-move/cedra-gas/src/cedra_framework.rs')
...
if __name__=='__main__':
    parser = argparse.ArgumentParser(
        description='Generate gas parameters for bulletproofs module in `cedra-move/cedra-gas/src/cedra_framework.rs`.')
