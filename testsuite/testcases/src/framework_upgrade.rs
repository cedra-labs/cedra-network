...
use cedra_release_builder::ReleaseConfig;
use cedra_sdk::crypto::{ed25519::Ed25519PrivateKey, PrivateKey};
...
const RELEASE_YAML_PATH: &str = "cedra-move/cedra-release-builder/data";
...
impl NetworkTest for FrameworkUpgrade {
    async fn run<'a>(&self, ctx: NetworkContextSynchronizer<'a>) -> Result<()> {
        ...
        let network_info = cedra_release_builder::validate::NetworkConfig {
            endpoint: ctx
                .swarm
                .read()
                .await
        ...
        let release_config = cedra_release_builder::current_release_config();

        cedra_release_builder::validate::validate_config(
