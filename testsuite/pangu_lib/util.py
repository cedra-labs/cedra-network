...
NODE_CONFIG_MOUNT_NAME: str = "cedra-config"
NODE_CONFIG_MOUNT_PATH: str = "/opt/cedra/etc"
GENESIS_ARTIFACTS_MOUNT_NAME: str = "genesis-config"
GENESIS_ARTIFACTS_MOUNT_PATH: str = "/opt/cedra/genesis"
NODE_IDENTITY_MOUNT_NAME: str = "cedra-secret"
NODE_IDENTITY_MOUNT_PATH: str = "/opt/cedra/identites"
...
DEFAULT_IMAGE: str = "cedralabs/validator:devnet@sha256:f0c62463b0e86acc9ad081c54be2d1823f143f780c73828b876caebc978c8947"
CEDRA_DATA_NAME: str = "cedra-data"
CEDRA_DATA_DIR: str = "/opt/cedra/data"
...
DEFAULT_TRANSACTION_EMITTER_IMAGE: str = "cedralabs/tools:devnet"
