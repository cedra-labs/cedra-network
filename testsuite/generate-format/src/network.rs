...
use cedra_network::protocols::wire::{handshake, messaging};
use cedra_types::network_address as address;
...
pub fn get_registry() -> Result<Registry> {
    ...
    tracer.trace_type::<cedra_config::network_id::NetworkId>(&samples)?;
