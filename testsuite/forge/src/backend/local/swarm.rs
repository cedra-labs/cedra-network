...
impl LocalSwarm {
        ...
        R: ::rand::RngCore + ::rand::CryptoRng,
    {
        ...
        let (root_key, genesis, genesis_waypoint, validators) =
            cedra_genesis::builder::Builder::new(
                &dir_actual,
                genesis_framework
                    .unwrap_or_else(|| cedra_cached_packages::head_release_bundle().clone()),
            )?
        ...
        let root_account = LocalAccount::new(
            cedra_sdk::types::account_config::cedra_test_root_address(),
