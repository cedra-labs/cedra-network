...
use cedra_crypto::{encoding_type::EncodingType, x25519, x25519::PrivateKey};
use cedra_forge::{FullNode, Node, NodeExt, Swarm};
...
async fn test_rest_discovery() {
    let mut swarm = SwarmBuilder::new_local(1).with_cedra().build().await;
...
// Currently this test seems flaky: https://github.com/cedra-labs/cedra-network/issues/670
#[ignore]
#[tokio::test]
