...
/// Previously get_bin triggered a rebuild of cedra-node, which caused issues that were only seen
/// during parallel execution of tests.
/// This test should make regressions obvious.
#[tokio::test]
async fn test_cedra_node_after_get_bin() {
    ...
    // Before #5308 this re-compiled cedra-node and caused a panic on the vfn.
    let _cedra_cli = crate::workspace_builder::get_bin("cedra");
