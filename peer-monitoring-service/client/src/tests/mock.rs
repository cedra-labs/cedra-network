...
use cedra_peer_monitoring_service_server::network::{NetworkRequest, ResponseSender};
use cedra_peer_monitoring_service_types::PeerMonitoringServiceMessage;
use cedra_time_service::TimeService;
use cedra_types::account_address::{AccountAddress as PeerId, AccountAddress};
...
impl MockMonitoringServer {
    pub fn new(
        ...
        for network_id in &all_network_ids {
            ...
            let queue_config = cedra_channel::Config::new(10).queue_style(QueueStyle::FIFO);
