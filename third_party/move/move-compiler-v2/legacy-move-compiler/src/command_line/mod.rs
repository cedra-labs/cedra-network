...
pub const WARN_OF_DEPRECATION_USE_IN_CEDRA_LIBS: &str = "WARN_OF_DEPRECATION_USE_IN_CEDRA_LIBS";
pub const WARN_OF_DEPRECATION_USE_IN_CEDRA_LIBS_FLAG: &str = "Wdeprecation-cedra";
