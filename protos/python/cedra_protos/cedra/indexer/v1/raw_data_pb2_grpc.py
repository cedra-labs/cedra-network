...
import grpc
from cedra.indexer.v1 import raw_data_pb2 as cedra_dot_indexer_dot_v1_dot_raw__data__pb2
...
class RawDataStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetTransactions = channel.unary_stream(
            ...
            request_serializer=cedra_dot_indexer_dot_v1_dot_raw__data__pb2.GetTransactionsRequest.SerializeToString,
            response_deserializer=cedra_dot_indexer_dot_v1_dot_raw__data__pb2.TransactionsResponse.FromString,
        )
...
def add_RawDataServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
        "cedra.indexer.v1.RawData", rpc_method_handlers
    )
