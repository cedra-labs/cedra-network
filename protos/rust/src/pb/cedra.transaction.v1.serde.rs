...
impl serde::Serialize for AbstractionSignature {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.AbstractionSignature", len)?;
        if !self.function_info.is_empty() {
...
impl<'de> serde::Deserialize<'de> for AbstractionSignature {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.AbstractionSignature")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<AbstractionSignature, V::Error>
                where
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::FunctionInfo => {
                            ...
                            function_info__ = Some(map_.next_value()?);
                        }
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.AbstractionSignature", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for AccountSignature {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.AccountSignature", len)?;
        if self.r#type != 0 {
            let v = account_signature::Type::try_from(self.r#type)
...
impl<'de> serde::Deserialize<'de> for AccountSignature {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.AccountSignature")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<AccountSignature, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Type => {
                            ...
                            r#type__ = Some(map_.next_value::<account_signature::Type>()? as i32);
                        }
                        GeneratedField::Ed25519 => {
                            if signature__.is_some() {
                                return Err(serde::de::Error::duplicate_field("ed25519"));
                            }
                            signature__ = map_.next_value::<::std::option::Option<_>>()?.map(account_signature::Signature::Ed25519)
;
                        }
                        GeneratedField::MultiEd25519 => {
                            ...
                            signature__ = map_.next_value::<::std::option::Option<_>>()?.map(account_signature::Signature::MultiEd25519)
;
                        }
                        GeneratedField::SingleKeySignature => {
                            ...
                            signature__ = map_.next_value::<::std::option::Option<_>>()?.map(account_signature::Signature::SingleKeySignature)
;
                        }
                        GeneratedField::MultiKeySignature => {
                            ...
                            signature__ = map_.next_value::<::std::option::Option<_>>()?.map(account_signature::Signature::MultiKeySignature)
;
                        }
                        GeneratedField::Abstraction => {
                            ...
                            signature__ = map_.next_value::<::std::option::Option<_>>()?.map(account_signature::Signature::Abstraction)
;
                        }
                    }
                }
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.AccountSignature", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for AnyPublicKey {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.AnyPublicKey", len)?;
        if self.r#type != 0 {
            let v = any_public_key::Type::try_from(self.r#type)
                .map_err(|_| serde::ser::Error::custom(format!("Invalid variant {}", self.r#type)))?;
            struct_ser.serialize_field("type", &v)?;
        }
        if !self.public_key.is_empty() {
...
impl<'de> serde::Deserialize<'de> for AnyPublicKey {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.AnyPublicKey")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<AnyPublicKey, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut r#type__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Type => {
                            ...
                            r#type__ = Some(map_.next_value::<any_public_key::Type>()? as i32);
                        }
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.AnyPublicKey", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for AnySignature {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.AnySignature", len)?;
        if self.r#type != 0 {
            let v = any_signature::Type::try_from(self.r#type)
                .map_err(|_| serde::ser::Error::custom(format!("Invalid variant {}", self.r#type)))?;
            struct_ser.serialize_field("type", &v)?;
        }
        if !self.signature.is_empty() {
...
impl<'de> serde::Deserialize<'de> for AnySignature {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.AnySignature")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<AnySignature, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut r#type__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Type => {
                            ...
                            r#type__ = Some(map_.next_value::<any_signature::Type>()? as i32);
                        }
                        GeneratedField::Signature => {
                            if signature__.is_some() {
                                return Err(serde::de::Error::duplicate_field("signature"));
                        ...
                        GeneratedField::Ed25519 => {
                            ...
                            signature_variant__ = map_.next_value::<::std::option::Option<_>>()?.map(any_signature::SignatureVariant::Ed25519)
;
                        }
                        GeneratedField::Secp256k1Ecdsa => {
                            ...
                            signature_variant__ = map_.next_value::<::std::option::Option<_>>()?.map(any_signature::SignatureVariant::Secp256k1Ecdsa)
;
                        }
                        GeneratedField::Webauthn => {
                            ...
                            signature_variant__ = map_.next_value::<::std::option::Option<_>>()?.map(any_signature::SignatureVariant::Webauthn)
;
                        }
                        GeneratedField::Keyless => {
                            ...
                            signature_variant__ = map_.next_value::<::std::option::Option<_>>()?.map(any_signature::SignatureVariant::Keyless)
;
                        }
                    }
                }
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.AnySignature", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for Block {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.Block", len)?;
...
impl<'de> serde::Deserialize<'de> for Block {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.Block")
            }
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.Block", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for BlockEndInfo {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.BlockEndInfo", len)?;
        if self.block_gas_limit_reached {
...
impl<'de> serde::Deserialize<'de> for BlockEndInfo {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.BlockEndInfo")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<BlockEndInfo, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::BlockGasLimitReached => {
                            ...
                            block_gas_limit_reached__ = Some(map_.next_value()?);
                        }
                        GeneratedField::BlockOutputLimitReached => {
                            ...
                            block_output_limit_reached__ = Some(map_.next_value()?);
                        }
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.BlockEndInfo", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for BlockEpilogueTransaction {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.BlockEpilogueTransaction", len)?;
...
impl<'de> serde::Deserialize<'de> for BlockEpilogueTransaction {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.BlockEpilogueTransaction")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<BlockEpilogueTransaction, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::BlockEndInfo => {
                            ...
                            block_end_info__ = map_.next_value()?;
                        }
                    }
                }
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.BlockEpilogueTransaction", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for BlockMetadataTransaction {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.BlockMetadataTransaction", len)?;
        if !self.id.is_empty() {
...
impl<'de> serde::Deserialize<'de> for BlockMetadataTransaction {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.BlockMetadataTransaction")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<BlockMetadataTransaction, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut id__ = None;
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.BlockMetadataTransaction", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DeleteModule {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.DeleteModule", len)?;
        if !self.address.is_empty() {
...
impl<'de> serde::Deserialize<'de> for DeleteModule {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.DeleteModule")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<DeleteModule, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.DeleteModule", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DeleteResource {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.DeleteResource", len)?;
        if !self.address.is_empty() {
            struct_ser.serialize_field("address", &self.address)?;
        }
        if !self.state_key_hash.is_empty() {
...
impl<'de> serde::Deserialize<'de> for DeleteResource {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.DeleteResource")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<DeleteResource, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut address__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::TypeStr => {
                            ...
                            type_str__ = Some(map_.next_value()?);
                        }
                    }
                }
                Ok(DeleteResource {
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.DeleteResource", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DeleteTableData {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.DeleteTableData", len)?;
        if !self.key.is_empty() {
...
impl<'de> serde::Deserialize<'de> for DeleteTableData {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.DeleteTableData")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<DeleteTableData, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut key__ = None;
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.DeleteTableData", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DeleteTableItem {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.DeleteTableItem", len)?;
        if !self.state_key_hash.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("stateKeyHash", pbjson::private::base64::encode(&self.state_key_hash).as_str())?;
...
impl<'de> serde::Deserialize<'de> for DeleteTableItem {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.DeleteTableItem")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<DeleteTableItem, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut state_key_hash__ = None;
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.DeleteTableItem", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DirectWriteSet {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.DirectWriteSet", len)?;
        if !self.write_set_change.is_empty() {
...
impl<'de> serde::Deserialize<'de> for DirectWriteSet {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.DirectWriteSet")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<DirectWriteSet, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::WriteSetChange => {
                            ...
                            write_set_change__ = Some(map_.next_value()?);
                        }
                        GeneratedField::Events => {
                            if events__.is_some() {
                                return Err(serde::de::Error::duplicate_field("events"));
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.DirectWriteSet", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Ed25519 {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.Ed25519", len)?;
        if !self.signature.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("signature", pbjson::private::base64::encode(&self.signature).as_str())?;
...
impl<'de> serde::Deserialize<'de> for Ed25519 {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.Ed25519")
            }
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.Ed25519", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Ed25519Signature {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.Ed25519Signature", len)?;
        if !self.public_key.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("publicKey", pbjson::private::base64::encode(&self.public_key).as_str())?;
...
impl<'de> serde::Deserialize<'de> for Ed25519Signature {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.Ed25519Signature")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<Ed25519Signature, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut public_key__ = None;
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.Ed25519Signature", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for EntryFunctionId {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.EntryFunctionId", len)?;
        if let Some(v) = self.module.as_ref() {
            struct_ser.serialize_field("module", v)?;
        }
        if !self.name.is_empty() {
...
impl<'de> serde::Deserialize<'de> for EntryFunctionId {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.EntryFunctionId")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<EntryFunctionId, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut module__ = None;
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.EntryFunctionId", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for EntryFunctionPayload {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.EntryFunctionPayload", len)?;
...
impl<'de> serde::Deserialize<'de> for EntryFunctionPayload {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.EntryFunctionPayload")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<EntryFunctionPayload, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::EntryFunctionIdStr => {
                            ...
                            entry_function_id_str__ = Some(map_.next_value()?);
                        }
                    }
                }
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.EntryFunctionPayload", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Event {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.Event", len)?;
...
impl<'de> serde::Deserialize<'de> for Event {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.Event")
            }
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.Event", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for EventKey {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.EventKey", len)?;
        if self.creation_number != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for EventKey {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.EventKey")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<EventKey, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.EventKey", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for EventSizeInfo {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.EventSizeInfo", len)?;
        if self.type_tag_bytes != 0 {
...
impl<'de> serde::Deserialize<'de> for EventSizeInfo {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.EventSizeInfo")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<EventSizeInfo, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.EventSizeInfo", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ExtraConfigV1 {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.ExtraConfigV1", len)?;
...
impl<'de> serde::Deserialize<'de> for ExtraConfigV1 {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.ExtraConfigV1")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ExtraConfigV1, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::MultisigAddress => {
                            ...
                            multisig_address__ = map_.next_value()?;
                        }
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.ExtraConfigV1", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FeePayerSignature {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.FeePayerSignature", len)?;
...
impl<'de> serde::Deserialize<'de> for FeePayerSignature {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.FeePayerSignature")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<FeePayerSignature, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.FeePayerSignature", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GenesisTransaction {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.GenesisTransaction", len)?;
...
impl<'de> serde::Deserialize<'de> for GenesisTransaction {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.GenesisTransaction")
            }
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.GenesisTransaction", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for IndexedSignature {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.IndexedSignature", len)?;
        if self.index != 0 {
...
impl<'de> serde::Deserialize<'de> for IndexedSignature {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.IndexedSignature")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<IndexedSignature, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.IndexedSignature", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Keyless {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.Keyless", len)?;
        if !self.signature.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("signature", pbjson::private::base64::encode(&self.signature).as_str())?;
...
impl<'de> serde::Deserialize<'de> for Keyless {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.Keyless")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<Keyless, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut signature__ = None;
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.Keyless", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for MoveFunction {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.MoveFunction", len)?;
        if !self.name.is_empty() {
            struct_ser.serialize_field("name", &self.name)?;
        }
        if self.visibility != 0 {
            let v = move_function::Visibility::try_from(self.visibility)
...
impl<'de> serde::Deserialize<'de> for MoveFunction {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.MoveFunction")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<MoveFunction, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut name__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::Visibility => {
                            ...
                            visibility__ = Some(map_.next_value::<move_function::Visibility>()? as i32);
                        }
                        GeneratedField::IsEntry => {
                            if is_entry__.is_some() {
                                return Err(serde::de::Error::duplicate_field("isEntry"));
                            }
                            is_entry__ = Some(map_.next_value()?);
                        }
                        GeneratedField::GenericTypeParams => {
                            ...
                            generic_type_params__ = Some(map_.next_value()?);
                        }
                        ...
                        GeneratedField::Return => {
                            ...
                            r#return__ = Some(map_.next_value()?);
                        }
                    }
                }
                Ok(MoveFunction {
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.MoveFunction", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for MoveFunctionGenericTypeParam {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.MoveFunctionGenericTypeParam", len)?;
        if !self.constraints.is_empty() {
            let v = self.constraints.iter().cloned().map(|v| {
                MoveAbility::try_from(v)
...
impl<'de> serde::Deserialize<'de> for MoveFunctionGenericTypeParam {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.MoveFunctionGenericTypeParam")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<MoveFunctionGenericTypeParam, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Constraints => {
                            ...
                            constraints__ = Some(map_.next_value::<Vec<MoveAbility>>()?.into_iter().map(|x| x as i32).collect());
                        }
                    }
                }
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.MoveFunctionGenericTypeParam", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MoveModule {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.MoveModule", len)?;
        if !self.address.is_empty() {
            struct_ser.serialize_field("address", &self.address)?;
        }
        if !self.name.is_empty() {
...
impl<'de> serde::Deserialize<'de> for MoveModule {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.MoveModule")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<MoveModule, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut address__ = None;
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.MoveModule", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MoveModuleBytecode {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.MoveModuleBytecode", len)?;
        if !self.bytecode.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for MoveModuleBytecode {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.MoveModuleBytecode")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<MoveModuleBytecode, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.MoveModuleBytecode", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MoveModuleId {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.MoveModuleId", len)?;
        if !self.address.is_empty() {
            struct_ser.serialize_field("address", &self.address)?;
        }
        if !self.name.is_empty() {
...
impl<'de> serde::Deserialize<'de> for MoveModuleId {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.MoveModuleId")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<MoveModuleId, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut address__ = None;
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.MoveModuleId", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MoveScriptBytecode {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.MoveScriptBytecode", len)?;
        if !self.bytecode.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("bytecode", pbjson::private::base64::encode(&self.bytecode).as_str())?;
...
impl<'de> serde::Deserialize<'de> for MoveScriptBytecode {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.MoveScriptBytecode")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<MoveScriptBytecode, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut bytecode__ = None;
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.MoveScriptBytecode", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MoveStruct {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.MoveStruct", len)?;
        if !self.name.is_empty() {
            struct_ser.serialize_field("name", &self.name)?;
        }
        if self.is_native {
...
impl<'de> serde::Deserialize<'de> for MoveStruct {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.MoveStruct")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<MoveStruct, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut name__ = None;
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.MoveStruct", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MoveStructField {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.MoveStructField", len)?;
        if !self.name.is_empty() {
            struct_ser.serialize_field("name", &self.name)?;
        }
        if let Some(v) = self.r#type.as_ref() {
...
impl<'de> serde::Deserialize<'de> for MoveStructField {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.MoveStructField")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<MoveStructField, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut name__ = None;
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.MoveStructField", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MoveStructGenericTypeParam {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.MoveStructGenericTypeParam", len)?;
        if !self.constraints.is_empty() {
            let v = self.constraints.iter().cloned().map(|v| {
                MoveAbility::try_from(v)
                    .map_err(|_| serde::ser::Error::custom(format!("Invalid variant {}", v)))
...
impl<'de> serde::Deserialize<'de> for MoveStructGenericTypeParam {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.MoveStructGenericTypeParam")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<MoveStructGenericTypeParam, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut constraints__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::IsPhantom => {
                            ...
                            is_phantom__ = Some(map_.next_value()?);
                        }
                    }
                }
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.MoveStructGenericTypeParam", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MoveStructTag {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.MoveStructTag", len)?;
        if !self.address.is_empty() {
            struct_ser.serialize_field("address", &self.address)?;
        }
        if !self.module.is_empty() {
...
impl<'de> serde::Deserialize<'de> for MoveStructTag {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.MoveStructTag")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<MoveStructTag, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut address__ = None;
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.MoveStructTag", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MoveType {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.MoveType", len)?;
        if self.r#type != 0 {
            let v = MoveTypes::try_from(self.r#type)
                .map_err(|_| serde::ser::Error::custom(format!("Invalid variant {}", self.r#type)))?;
            struct_ser.serialize_field("type", &v)?;
        }
...
impl<'de> serde::Deserialize<'de> for MoveType {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.MoveType")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<MoveType, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut r#type__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Type => {
                            ...
                            r#type__ = Some(map_.next_value::<MoveTypes>()? as i32);
                        }
                        GeneratedField::Vector => {
                            if content__.is_some() {
                                return Err(serde::de::Error::duplicate_field("vector"));
                            }
                            content__ = map_.next_value::<::std::option::Option<_>>()?.map(move_type::Content::Vector)
;
                        }
                        GeneratedField::Struct => {
                            ...
                            content__ = map_.next_value::<::std::option::Option<_>>()?.map(move_type::Content::Struct)
;
                        }
                        GeneratedField::GenericTypeParamIndex => {
                            ...
                            content__ = map_.next_value::<::std::option::Option<::pbjson::private::NumberDeserialize<_>>>()?.map(|x| move_type::Content::GenericTypeParamIndex(x.0));
                        }
                        GeneratedField::Reference => {
                            if content__.is_some() {
                                return Err(serde::de::Error::duplicate_field("reference"));
                            }
                            content__ = map_.next_value::<::std::option::Option<_>>()?.map(move_type::Content::Reference)
;
                        }
                        GeneratedField::Unparsable => {
                            ...
                            content__ = map_.next_value::<::std::option::Option<_>>()?.map(move_type::Content::Unparsable);
                        }
                    }
                }
                Ok(MoveType {
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.MoveType", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for move_type::ReferenceType {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.MoveType.ReferenceType", len)?;
        if self.mutable {
...
impl<'de> serde::Deserialize<'de> for move_type::ReferenceType {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.MoveType.ReferenceType")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<move_type::ReferenceType, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Mutable => {
                            ...
                            mutable__ = Some(map_.next_value()?);
                        }
                        GeneratedField::To => {
                            if to__.is_some() {
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.MoveType.ReferenceType", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for MultiAgentSignature {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.MultiAgentSignature", len)?;
        if let Some(v) = self.sender.as_ref() {
            struct_ser.serialize_field("sender", v)?;
        }
        if !self.secondary_signer_addresses.is_empty() {
...
impl<'de> serde::Deserialize<'de> for MultiAgentSignature {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.MultiAgentSignature")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<MultiAgentSignature, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut sender__ = None;
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.MultiAgentSignature", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MultiEd25519Signature {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.MultiEd25519Signature", len)?;
        if !self.public_keys.is_empty() {
...
impl<'de> serde::Deserialize<'de> for MultiEd25519Signature {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.MultiEd25519Signature")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<MultiEd25519Signature, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.MultiEd25519Signature", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MultiKeySignature {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.MultiKeySignature", len)?;
        if !self.public_keys.is_empty() {
...
impl<'de> serde::Deserialize<'de> for MultiKeySignature {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.MultiKeySignature")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<MultiKeySignature, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut public_keys__ = None;
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.MultiKeySignature", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MultisigPayload {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.MultisigPayload", len)?;
        if !self.multisig_address.is_empty() {
...
impl<'de> serde::Deserialize<'de> for MultisigPayload {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.MultisigPayload")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<MultisigPayload, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut multisig_address__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::MultisigAddress => {
                            ...
                            multisig_address__ = Some(map_.next_value()?);
                        }
                        GeneratedField::TransactionPayload => {
                            ...
                            transaction_payload__ = map_.next_value()?;
                        }
                    }
                }
                Ok(MultisigPayload {
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.MultisigPayload", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MultisigTransactionPayload {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.MultisigTransactionPayload", len)?;
        if self.r#type != 0 {
            let v = multisig_transaction_payload::Type::try_from(self.r#type)
                .map_err(|_| serde::ser::Error::custom(format!("Invalid variant {}", self.r#type)))?;
            struct_ser.serialize_field("type", &v)?;
        }
        if let Some(v) = self.payload.as_ref() {
...
impl<'de> serde::Deserialize<'de> for MultisigTransactionPayload {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.MultisigTransactionPayload")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<MultisigTransactionPayload, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut r#type__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Type => {
                            ...
                            r#type__ = Some(map_.next_value::<multisig_transaction_payload::Type>()? as i32);
                        }
                        GeneratedField::EntryFunctionPayload => {
                            if payload__.is_some() {
                                return Err(serde::de::Error::duplicate_field("entryFunctionPayload"));
                            }
                            payload__ = map_.next_value::<::std::option::Option<_>>()?.map(multisig_transaction_payload::Payload::EntryFunctionPayload)
;
                        }
                    }
                }
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.MultisigTransactionPayload", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for ScriptPayload {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.ScriptPayload", len)?;
...
impl<'de> serde::Deserialize<'de> for ScriptPayload {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.ScriptPayload")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ScriptPayload, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut code__ = None;
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.ScriptPayload", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ScriptWriteSet {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.ScriptWriteSet", len)?;
        if !self.execute_as.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ScriptWriteSet {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.ScriptWriteSet")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ScriptWriteSet, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::ExecuteAs => {
                            ...
                            execute_as__ = Some(map_.next_value()?);
                        }
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.ScriptWriteSet", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Secp256k1Ecdsa {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.Secp256k1Ecdsa", len)?;
        if !self.signature.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("signature", pbjson::private::base64::encode(&self.signature).as_str())?;
...
impl<'de> serde::Deserialize<'de> for Secp256k1Ecdsa {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.Secp256k1Ecdsa")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<Secp256k1Ecdsa, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut signature__ = None;
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.Secp256k1Ecdsa", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Signature {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.Signature", len)?;
        if self.r#type != 0 {
            let v = signature::Type::try_from(self.r#type)
                .map_err(|_| serde::ser::Error::custom(format!("Invalid variant {}", self.r#type)))?;
            struct_ser.serialize_field("type", &v)?;
        }
        if let Some(v) = self.signature.as_ref() {
...
impl<'de> serde::Deserialize<'de> for Signature {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.Signature")
            }
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Type => {
                            ...
                            r#type__ = Some(map_.next_value::<signature::Type>()? as i32);
                        }
                        GeneratedField::Ed25519 => {
                            if signature__.is_some() {
                                return Err(serde::de::Error::duplicate_field("ed25519"));
                            }
                            signature__ = map_.next_value::<::std::option::Option<_>>()?.map(signature::Signature::Ed25519)
;
                        }
                        GeneratedField::MultiEd25519 => {
                            if signature__.is_some() {
                            ...
                            signature__ = map_.next_value::<::std::option::Option<_>>()?.map(signature::Signature::MultiEd25519)
;
                        }
                        GeneratedField::MultiAgent => {
                            ...
                            signature__ = map_.next_value::<::std::option::Option<_>>()?.map(signature::Signature::MultiAgent)
;
                        }
                        GeneratedField::FeePayer => {
                            ...
                            signature__ = map_.next_value::<::std::option::Option<_>>()?.map(signature::Signature::FeePayer)
;
                        }
                        GeneratedField::SingleSender => {
                            ...
                            signature__ = map_.next_value::<::std::option::Option<_>>()?.map(signature::Signature::SingleSender)
;
                        }
                    }
                }
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.Signature", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for SingleKeySignature {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.SingleKeySignature", len)?;
...
impl<'de> serde::Deserialize<'de> for SingleKeySignature {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.SingleKeySignature")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<SingleKeySignature, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut public_key__ = None;
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.SingleKeySignature", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SingleSender {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.SingleSender", len)?;
        if let Some(v) = self.sender.as_ref() {
            struct_ser.serialize_field("sender", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for SingleSender {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.SingleSender")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<SingleSender, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut sender__ = None;
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.SingleSender", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for StateCheckpointTransaction {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("cedra.transaction.v1.StateCheckpointTransaction", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for StateCheckpointTransaction {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.StateCheckpointTransaction")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<StateCheckpointTransaction, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.StateCheckpointTransaction", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Transaction {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.Transaction", len)?;
        if let Some(v) = self.timestamp.as_ref() {
            struct_ser.serialize_field("timestamp", v)?;
        }
        if self.version != 0 {
        ...
        if self.r#type != 0 {
            let v = transaction::TransactionType::try_from(self.r#type)
                .map_err(|_| serde::ser::Error::custom(format!("Invalid variant {}", self.r#type)))?;
            struct_ser.serialize_field("type", &v)?;
        }
...
impl<'de> serde::Deserialize<'de> for Transaction {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.Transaction")
            }
...
;
                        ...
                        GeneratedField::Genesis => {
                            ...
                            txn_data__ = map_.next_value::<::std::option::Option<_>>()?.map(transaction::TxnData::Genesis)
;
                        }
                        GeneratedField::StateCheckpoint => {
                            ...
                            txn_data__ = map_.next_value::<::std::option::Option<_>>()?.map(transaction::TxnData::StateCheckpoint)
;
                        }
                        GeneratedField::User => {
                            if txn_data__.is_some() {
                            ...
                            txn_data__ = map_.next_value::<::std::option::Option<_>>()?.map(transaction::TxnData::User)
;
                        }
                        GeneratedField::Validator => {
                            ...
                            txn_data__ = map_.next_value::<::std::option::Option<_>>()?.map(transaction::TxnData::Validator)
;
                        }
                        GeneratedField::BlockEpilogue => {
                            ...
                            txn_data__ = map_.next_value::<::std::option::Option<_>>()?.map(transaction::TxnData::BlockEpilogue)
;
                        }
                    }
                }
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.Transaction", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for TransactionInfo {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.TransactionInfo", len)?;
        if !self.hash.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for TransactionInfo {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.TransactionInfo")
            }
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.TransactionInfo", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for TransactionPayload {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.TransactionPayload", len)?;
        if self.r#type != 0 {
            let v = transaction_payload::Type::try_from(self.r#type)
                .map_err(|_| serde::ser::Error::custom(format!("Invalid variant {}", self.r#type)))?;
            struct_ser.serialize_field("type", &v)?;
        }
        if let Some(v) = self.payload.as_ref() {
...
impl<'de> serde::Deserialize<'de> for TransactionPayload {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.TransactionPayload")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<TransactionPayload, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut r#type__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Type => {
                            ...
                            r#type__ = Some(map_.next_value::<transaction_payload::Type>()? as i32);
                        }
                        GeneratedField::EntryFunctionPayload => {
                            if payload__.is_some() {
                                return Err(serde::de::Error::duplicate_field("entryFunctionPayload"));
                            }
                            payload__ = map_.next_value::<::std::option::Option<_>>()?.map(transaction_payload::Payload::EntryFunctionPayload)
;
                        }
                        GeneratedField::ScriptPayload => {
                            ...
                            payload__ = map_.next_value::<::std::option::Option<_>>()?.map(transaction_payload::Payload::ScriptPayload)
;
                        }
                        GeneratedField::WriteSetPayload => {
                            ...
                            payload__ = map_.next_value::<::std::option::Option<_>>()?.map(transaction_payload::Payload::WriteSetPayload)
;
                        }
                        GeneratedField::MultisigPayload => {
                            ...
                            payload__ = map_.next_value::<::std::option::Option<_>>()?.map(transaction_payload::Payload::MultisigPayload)
;
                        }
                        GeneratedField::ExtraConfigV1 => {
                            ...
                            extra_config__ = map_.next_value::<::std::option::Option<_>>()?.map(transaction_payload::ExtraConfig::ExtraConfigV1)
;
                        }
                    }
                }
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.TransactionPayload", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for TransactionSizeInfo {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.TransactionSizeInfo", len)?;
        if self.transaction_bytes != 0 {
...
impl<'de> serde::Deserialize<'de> for TransactionSizeInfo {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.TransactionSizeInfo")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<TransactionSizeInfo, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.TransactionSizeInfo", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for UserTransaction {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.UserTransaction", len)?;
...
impl<'de> serde::Deserialize<'de> for UserTransaction {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.UserTransaction")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<UserTransaction, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.UserTransaction", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for UserTransactionRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.UserTransactionRequest", len)?;
        if !self.sender.is_empty() {
...
impl<'de> serde::Deserialize<'de> for UserTransactionRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.UserTransactionRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<UserTransactionRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut sender__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::ExpirationTimestampSecs => {
                            ...
                            expiration_timestamp_secs__ = map_.next_value()?;
                        }
                        GeneratedField::Payload => {
                            if payload__.is_some() {
                                return Err(serde::de::Error::duplicate_field("payload"));
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.UserTransactionRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ValidatorTransaction {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.ValidatorTransaction", len)?;
        if !self.events.is_empty() {
            struct_ser.serialize_field("events", &self.events)?;
        }
...
impl<'de> serde::Deserialize<'de> for ValidatorTransaction {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.ValidatorTransaction")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ValidatorTransaction, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut events__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::ObservedJwkUpdate => {
                            ...
                            validator_transaction_type__ = map_.next_value::<::std::option::Option<_>>()?.map(validator_transaction::ValidatorTransactionType::ObservedJwkUpdate)
;
                        }
                        GeneratedField::DkgUpdate => {
                            ...
                            validator_transaction_type__ = map_.next_value::<::std::option::Option<_>>()?.map(validator_transaction::ValidatorTransactionType::DkgUpdate)
;
                        }
                    }
                }
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.ValidatorTransaction", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for validator_transaction::DkgUpdate {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.ValidatorTransaction.DkgUpdate", len)?;
...
impl<'de> serde::Deserialize<'de> for validator_transaction::DkgUpdate {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.ValidatorTransaction.DkgUpdate")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<validator_transaction::DkgUpdate, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::DkgTranscript => {
                            ...
                            dkg_transcript__ = map_.next_value()?;
                        }
                    }
                }
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.ValidatorTransaction.DkgUpdate", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for validator_transaction::dkg_update::DkgTranscript {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.ValidatorTransaction.DkgUpdate.DkgTranscript", len)?;
        if self.epoch != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("epoch", ToString::to_string(&self.epoch).as_str())?;
...
impl<'de> serde::Deserialize<'de> for validator_transaction::dkg_update::DkgTranscript {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.ValidatorTransaction.DkgUpdate.DkgTranscript")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<validator_transaction::dkg_update::DkgTranscript, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut epoch__ = None;
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.ValidatorTransaction.DkgUpdate.DkgTranscript", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for validator_transaction::ObservedJwkUpdate {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.ValidatorTransaction.ObservedJwkUpdate", len)?;
...
impl<'de> serde::Deserialize<'de> for validator_transaction::ObservedJwkUpdate {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.ValidatorTransaction.ObservedJwkUpdate")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<validator_transaction::ObservedJwkUpdate, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::QuorumCertifiedUpdate => {
                            ...
                            quorum_certified_update__ = map_.next_value()?;
                        }
                    }
                }
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.ValidatorTransaction.ObservedJwkUpdate", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for validator_transaction::observed_jwk_update::ExportedAggregateSignature {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.ValidatorTransaction.ObservedJwkUpdate.ExportedAggregateSignature", len)?;
        if !self.signer_indices.is_empty() {
...
impl<'de> serde::Deserialize<'de> for validator_transaction::observed_jwk_update::ExportedAggregateSignature {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.ValidatorTransaction.ObservedJwkUpdate.ExportedAggregateSignature")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<validator_transaction::observed_jwk_update::ExportedAggregateSignature, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.ValidatorTransaction.ObservedJwkUpdate.ExportedAggregateSignature", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for validator_transaction::observed_jwk_update::ExportedProviderJwKs {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.ValidatorTransaction.ObservedJwkUpdate.ExportedProviderJWKs", len)?;
        if !self.issuer.is_empty() {
...
impl<'de> serde::Deserialize<'de> for validator_transaction::observed_jwk_update::ExportedProviderJwKs {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.ValidatorTransaction.ObservedJwkUpdate.ExportedProviderJWKs")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<validator_transaction::observed_jwk_update::ExportedProviderJwKs, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.ValidatorTransaction.ObservedJwkUpdate.ExportedProviderJWKs", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for validator_transaction::observed_jwk_update::exported_provider_jw_ks::Jwk {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.ValidatorTransaction.ObservedJwkUpdate.ExportedProviderJWKs.JWK", len)?;
...
impl<'de> serde::Deserialize<'de> for validator_transaction::observed_jwk_update::exported_provider_jw_ks::Jwk {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.ValidatorTransaction.ObservedJwkUpdate.ExportedProviderJWKs.JWK")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<validator_transaction::observed_jwk_update::exported_provider_jw_ks::Jwk, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::UnsupportedJwk => {
                            ...
                            jwk_type__ = map_.next_value::<::std::option::Option<_>>()?.map(validator_transaction::observed_jwk_update::exported_provider_jw_ks::jwk::JwkType::UnsupportedJwk)
;
                        }
                        GeneratedField::Rsa => {
                            if jwk_type__.is_some() {
                            ...
                            jwk_type__ = map_.next_value::<::std::option::Option<_>>()?.map(validator_transaction::observed_jwk_update::exported_provider_jw_ks::jwk::JwkType::Rsa)
;
                        }
                    }
                }
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.ValidatorTransaction.ObservedJwkUpdate.ExportedProviderJWKs.JWK", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for validator_transaction::observed_jwk_update::exported_provider_jw_ks::jwk::Rsa {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.ValidatorTransaction.ObservedJwkUpdate.ExportedProviderJWKs.JWK.RSA", len)?;
        if !self.kid.is_empty() {
...
impl<'de> serde::Deserialize<'de> for validator_transaction::observed_jwk_update::exported_provider_jw_ks::jwk::Rsa {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.ValidatorTransaction.ObservedJwkUpdate.ExportedProviderJWKs.JWK.RSA")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<validator_transaction::observed_jwk_update::exported_provider_jw_ks::jwk::Rsa, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut kid__ = None;
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.ValidatorTransaction.ObservedJwkUpdate.ExportedProviderJWKs.JWK.RSA", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for validator_transaction::observed_jwk_update::exported_provider_jw_ks::jwk::UnsupportedJwk {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.ValidatorTransaction.ObservedJwkUpdate.ExportedProviderJWKs.JWK.UnsupportedJWK", len)?;
        if !self.id.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for validator_transaction::observed_jwk_update::exported_provider_jw_ks::jwk::UnsupportedJwk {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.ValidatorTransaction.ObservedJwkUpdate.ExportedProviderJWKs.JWK.UnsupportedJWK")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<validator_transaction::observed_jwk_update::exported_provider_jw_ks::jwk::UnsupportedJwk, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut id__ = None;
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.ValidatorTransaction.ObservedJwkUpdate.ExportedProviderJWKs.JWK.UnsupportedJWK", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for validator_transaction::observed_jwk_update::QuorumCertifiedUpdate {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.ValidatorTransaction.ObservedJwkUpdate.QuorumCertifiedUpdate", len)?;
...
impl<'de> serde::Deserialize<'de> for validator_transaction::observed_jwk_update::QuorumCertifiedUpdate {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.ValidatorTransaction.ObservedJwkUpdate.QuorumCertifiedUpdate")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<validator_transaction::observed_jwk_update::QuorumCertifiedUpdate, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.ValidatorTransaction.ObservedJwkUpdate.QuorumCertifiedUpdate", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for WebAuthn {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.WebAuthn", len)?;
        if !self.signature.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("signature", pbjson::private::base64::encode(&self.signature).as_str())?;
...
impl<'de> serde::Deserialize<'de> for WebAuthn {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.WebAuthn")
            }
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.WebAuthn", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for WriteModule {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.WriteModule", len)?;
        if !self.address.is_empty() {
            struct_ser.serialize_field("address", &self.address)?;
        }
        if !self.state_key_hash.is_empty() {
...
impl<'de> serde::Deserialize<'de> for WriteModule {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.WriteModule")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<WriteModule, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut address__ = None;
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.WriteModule", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for WriteOpSizeInfo {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.WriteOpSizeInfo", len)?;
        if self.key_bytes != 0 {
...
impl<'de> serde::Deserialize<'de> for WriteOpSizeInfo {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.WriteOpSizeInfo")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<WriteOpSizeInfo, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.WriteOpSizeInfo", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for WriteResource {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.WriteResource", len)?;
        if !self.address.is_empty() {
            struct_ser.serialize_field("address", &self.address)?;
        }
        if !self.state_key_hash.is_empty() {
...
impl<'de> serde::Deserialize<'de> for WriteResource {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.WriteResource")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<WriteResource, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut address__ = None;
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.WriteResource", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for WriteSet {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.WriteSet", len)?;
        if self.write_set_type != 0 {
            let v = write_set::WriteSetType::try_from(self.write_set_type)
                .map_err(|_| serde::ser::Error::custom(format!("Invalid variant {}", self.write_set_type)))?;
...
impl<'de> serde::Deserialize<'de> for WriteSet {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.WriteSet")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<WriteSet, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::WriteSetType => {
                            ...
                            write_set_type__ = Some(map_.next_value::<write_set::WriteSetType>()? as i32);
                        }
                        GeneratedField::ScriptWriteSet => {
                            if write_set__.is_some() {
                                return Err(serde::de::Error::duplicate_field("scriptWriteSet"));
                            }
                            write_set__ = map_.next_value::<::std::option::Option<_>>()?.map(write_set::WriteSet::ScriptWriteSet)
;
                        }
                        GeneratedField::DirectWriteSet => {
                            ...
                            write_set__ = map_.next_value::<::std::option::Option<_>>()?.map(write_set::WriteSet::DirectWriteSet)
;
                        }
                    }
                }
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.WriteSet", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for WriteSetChange {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.WriteSetChange", len)?;
        if self.r#type != 0 {
            let v = write_set_change::Type::try_from(self.r#type)
                .map_err(|_| serde::ser::Error::custom(format!("Invalid variant {}", self.r#type)))?;
            struct_ser.serialize_field("type", &v)?;
        }
...
impl<'de> serde::Deserialize<'de> for WriteSetChange {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.WriteSetChange")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<WriteSetChange, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut r#type__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Type => {
                            ...
                            r#type__ = Some(map_.next_value::<write_set_change::Type>()? as i32);
                        }
                        GeneratedField::DeleteModule => {
                            if change__.is_some() {
                                return Err(serde::de::Error::duplicate_field("deleteModule"));
                            }
                            change__ = map_.next_value::<::std::option::Option<_>>()?.map(write_set_change::Change::DeleteModule)
;
                        }
                        GeneratedField::DeleteResource => {
                            ...
                            change__ = map_.next_value::<::std::option::Option<_>>()?.map(write_set_change::Change::DeleteResource)
;
                        }
                        GeneratedField::DeleteTableItem => {
                            ...
                            change__ = map_.next_value::<::std::option::Option<_>>()?.map(write_set_change::Change::DeleteTableItem)
;
                        }
                        GeneratedField::WriteModule => {
                            ...
                            change__ = map_.next_value::<::std::option::Option<_>>()?.map(write_set_change::Change::WriteModule)
;
                        }
                        GeneratedField::WriteResource => {
                            ...
                            change__ = map_.next_value::<::std::option::Option<_>>()?.map(write_set_change::Change::WriteResource)
;
                        }
                        GeneratedField::WriteTableItem => {
                            ...
                            change__ = map_.next_value::<::std::option::Option<_>>()?.map(write_set_change::Change::WriteTableItem)
;
                        }
                    }
                }
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.WriteSetChange", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for WriteSetPayload {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.WriteSetPayload", len)?;
        if let Some(v) = self.write_set.as_ref() {
...
impl<'de> serde::Deserialize<'de> for WriteSetPayload {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.WriteSetPayload")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<WriteSetPayload, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut write_set__ = None;
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.WriteSetPayload", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for WriteTableData {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.WriteTableData", len)?;
        if !self.key.is_empty() {
            struct_ser.serialize_field("key", &self.key)?;
        }
        if !self.key_type.is_empty() {
...
impl<'de> serde::Deserialize<'de> for WriteTableData {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.WriteTableData")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<WriteTableData, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut key__ = None;
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.WriteTableData", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for WriteTableItem {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.WriteTableItem", len)?;
        if !self.state_key_hash.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("stateKeyHash", pbjson::private::base64::encode(&self.state_key_hash).as_str())?;
...
impl<'de> serde::Deserialize<'de> for WriteTableItem {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.WriteTableItem")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<WriteTableItem, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut state_key_hash__ = None;
        ...
        deserializer.deserialize_struct("cedra.transaction.v1.WriteTableItem", FIELDS, GeneratedVisitor)
    }
}
