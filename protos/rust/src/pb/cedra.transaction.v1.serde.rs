        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.validator_transaction_type.as_ref() {
            match v {
                ...
                validator_transaction::ValidatorTransactionType::AddPrice(v) => {
                    struct_ser.serialize_field("addPrice", v)?;
                }
                validator_transaction::ValidatorTransactionType::RemovePrice(v) => {
                    struct_ser.serialize_field("removePrice", v)?;
                }
            }
        }
        struct_ser.end()
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "addPrice" | "add_price" => Ok(GeneratedField::AddPrice),
                            "removePrice" | "remove_price" => Ok(GeneratedField::RemovePrice),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
...
;
                        ...
                        GeneratedField::AddPrice => {
                            if validator_transaction_type__.is_some() {
                                return Err(serde::de::Error::duplicate_field("addPrice"));
                            }
                            validator_transaction_type__ = map.next_value::<::std::option::Option<_>>()?.map(validator_transaction::ValidatorTransactionType::AddPrice)
;
                        }
                        GeneratedField::RemovePrice => {
                            if validator_transaction_type__.is_some() {
                                return Err(serde::de::Error::duplicate_field("removePrice"));
                            }
                            validator_transaction_type__ = map.next_value::<::std::option::Option<_>>()?.map(validator_transaction::ValidatorTransactionType::RemovePrice)
;
                        }
                    }
                }
...
impl serde::Serialize for validator_transaction::AddPrice {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let mut len = 0;
        if !self.price_info.is_empty() {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.ValidatorTransaction.AddPrice", len)?;
        if !self.price_info.is_empty() {
            struct_ser.serialize_field("priceInfo", &self.price_info)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for validator_transaction::AddPrice {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::Deserialize<'de> for GeneratedField {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    {
                        match value {
                            "priceInfo" | "price_info" => Ok(GeneratedField::PriceInfo),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = validator_transaction::AddPrice;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.ValidatorTransaction.AddPrice")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<validator_transaction::AddPrice, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut price_info__ = None;
                while let Some(k) = map.next_key()? {
                    match k {
                        GeneratedField::PriceInfo => {
                            if price_info__.is_some() {
                                return Err(serde::de::Error::duplicate_field("priceInfo"));
                            }
                            price_info__ = Some(map.next_value()?);
                        }
                    }
                }
                Ok(validator_transaction::AddPrice {
                    price_info: price_info__.unwrap_or_default(),
                })
            }
        }
                ...
                while let Some(k) = map.next_key()? {
                    match k {
                        GeneratedField::FaAddress => {
                            if fa_address__.is_some() {
                                return Err(serde::de::Error::duplicate_field("faAddress"));
                            }
                            fa_address__ = Some(map.next_value()?);
                        }
...
impl serde::Serialize for validator_transaction::RemovePrice {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cedra.transaction.v1.ValidatorTransaction.RemovePrice", len)?;
        if !self.fa_address.is_empty() {
            struct_ser.serialize_field("faAddress", &self.fa_address)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for validator_transaction::RemovePrice {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = validator_transaction::RemovePrice;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cedra.transaction.v1.ValidatorTransaction.RemovePrice")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<validator_transaction::RemovePrice, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut fa_address__ = None;
                ...
                Ok(validator_transaction::RemovePrice {
                    fa_address: fa_address__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("cedra.transaction.v1.ValidatorTransaction.RemovePrice", FIELDS, GeneratedVisitor)
    }
}
