...
impl serde::Serialize for Empty {
        ...
        S: serde::Serializer,
    {
        ...
        let len = 0;
        let struct_ser = serializer.serialize_struct("cedra.remote_executor.v1.Empty", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for Empty {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("cedra.remote_executor.v1.Empty", FIELDS, GeneratedVisitor)
    }
}
...
impl<'de> serde::Deserialize<'de> for NetworkMessage {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("cedra.remote_executor.v1.NetworkMessage", FIELDS, GeneratedVisitor)
    }
}
