...
export const RawDataService = {
  ...
  getTransactions: {
    path: "/cedra.indexer.v1.RawData/GetTransactions",
    requestStream: false,
    responseStream: true,
...
export const RawDataClient = makeGenericClientConstructor(RawDataService, "cedra.indexer.v1.RawData") as unknown as {
