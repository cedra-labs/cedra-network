...
# This script runs the fullnode-sync from the root of cedra-core.

# Useful file constants
FAST_SYNC_BOOTSTRAPPING_MODE = "DownloadLatestStates" # The bootstrapping string for fast sync
FULLNODE_CONFIG_NAME = "public_full_node.yaml" # Relative to the cedra-core repo
FULLNODE_CONFIG_TEMPLATE_PATH = "config/src/config/test_data/public_full_node.yaml" # Relative to the cedra-core repo
...
def checkout_git_ref(git_ref):
  """Checkout the specified git ref. This assumes the working directory is cedra-core"""
