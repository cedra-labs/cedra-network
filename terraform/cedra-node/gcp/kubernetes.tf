provider "kubernetes" {
  host                   = "https://${google_container_cluster.cedra.endpoint}"
  cluster_ca_certificate = base64decode(google_container_cluster.cedra.master_auth[0].cluster_ca_certificate)
