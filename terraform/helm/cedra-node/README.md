...
Cedra blockchain node deployment
...
| fullnode.config | object | `{"full_node_networks":[{"network_id":"public"}]}` | Fullnode configuration. See NodeConfig https://github.com/cedra-labs/cedra-network/blob/main/config/src/config/mod.rs |
...
| genesis_blob_upload_url | string | `"https://us-west1-cedra-forge-gcp-0.cloudfunctions.net/signed-url?cluster_name=unknown&era=1"` |  |
