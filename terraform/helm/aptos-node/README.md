...
| fullnode.config | object | `{"full_node_networks":[{"network_id":"public"}]}` | Fullnode configuration. See NodeConfig https://github.com/cedra-labs/cedra/blob/main/config/src/config/mod.rs |
