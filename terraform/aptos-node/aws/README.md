...
Install pre-requisites if needed:
   ...
   * Cedra CLI: https://github.com/cedra-labs/cedra/releases/tag/cedra-cli-v0.1.0-alpha
...
For the full customization options, see the variables file [here](https://github.com/cedra-labs/cedra/blob/main/terraform/cedra-node/aws/variables.tf), and the [helm values](https://github.com/cedra-labs/cedra/blob/main/terraform/helm/cedra-node/values.yaml).
