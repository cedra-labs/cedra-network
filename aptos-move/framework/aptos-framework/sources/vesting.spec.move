spec aptos_framework::vesting {
    ...
    /// period.
    /// Enforcement: Audited the check for the end of vesting cliff: [https://github.com/cedra-labs/cedra/blob/main/aptos-move/framework/aptos-framework/sources/vesting.move#L566](vest) module.
    ///
    /// No.: 5
    ...
    spec create_vesting_contract_account(
        ...
        aborts_if !exists<coin::CoinStore<CedraCoin>>(resource_addr) && !aptos_std::type_info::spec_is_struct<CedraCoin>();
