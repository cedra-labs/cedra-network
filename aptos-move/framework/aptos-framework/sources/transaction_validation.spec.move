spec aptos_framework::transaction_validation {
    ...
    spec schema EpilogueGasPayerAbortsIf {
        ...
        use aptos_framework::transaction_fee::{CedraCoinCapabilities, CedraCoinMintCapability};
        ...
        aborts_if amount_to_burn > 0 && !exists<CedraCoinCapabilities>(@aptos_framework);
        ...
        aborts_if amount_to_mint > 0 && !exists<CedraCoinMintCapability>(@aptos_framework);
        ...
        aborts_if (amount_to_mint != 0) && !exists<coin::CoinInfo<CedraCoin>>(aptos_addr);
