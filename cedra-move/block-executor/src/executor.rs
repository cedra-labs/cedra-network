...
use crate::{
    ...
    code_cache_global_manager::CedraModuleCacheManagerGuard,
    counters::{
...
use cedra_drop_helper::DEFAULT_DROPPER;
...
use cedra_vm_logging::{alert, clear_speculative_txn_logs, init_speculative_logs, prelude::*};
use cedra_vm_types::{
    ...
    TP: TxnProvider<T> + Sync,
{
    ...
    pub(crate) fn execute_transactions_parallel(
        ...
        signature_verified_block: &TP,
        base_view: &S,
        module_cache_manager_guard: &mut CedraModuleCacheManagerGuard,
    ...
    fn add_module_write_to_module_cache(
        ...
        per_block_module_cache: &impl ModuleCache<
            ...
            Verified = Module,
            Extension = CedraModuleExtension,
