...
pub use crate::{
    cedra_framework_sdk_builder::*, cedra_token_objects_sdk_builder as cedra_token_objects_stdlib,
    cedra_token_sdk_builder as cedra_token_stdlib,
};
...
pub fn cedra_coin_transfer(to: AccountAddress, amount: u64) -> TransactionPayload {
    coin_transfer(CedraCoinType::type_tag(), to, amount)
}
