...
/// a general conversion back-and-force is needed, consider the `cedra_std::Any` type which preserves invariants.
///
/// Example:
/// ```
/// use std::bcs;
...
module cedra_std::from_bcs {
    ...
    friend cedra_std::any;
    friend cedra_std::copyable_any;
