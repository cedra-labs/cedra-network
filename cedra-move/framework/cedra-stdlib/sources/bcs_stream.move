...
/// - Exception: For the `deserialize_address` function, the function-based approach from `cedra_std::from_bcs` is used
...
module cedra_std::bcs_stream {
    ...
    /// This function utilizes the `to_address` function from the `cedra_std::from_bcs` module,
