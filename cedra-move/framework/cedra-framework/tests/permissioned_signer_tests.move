#[test_only]
module cedra_framework::permissioned_signer_tests {
    use std::bcs;
    use std::features;
    use cedra_framework::account::create_signer_for_test;
    ...
    fun test_permission_e2e(creator: &signer) {
        let cedra_framework = create_signer_for_test(@0x1);
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(
        abort_code = 0x50005, location = cedra_framework::permissioned_signer
    )]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(
        abort_code = 0x50002, location = cedra_framework::permissioned_signer
    )]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(
        abort_code = 0x50001, location = cedra_framework::permissioned_signer
    )]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(
        abort_code = 0x50007, location = cedra_framework::permissioned_signer
    )]
    ...
    #[expected_failure(
        abort_code = 0x50008, location = cedra_framework::permissioned_signer
    )]
