...
module 0xcafe::deflation_token {
    use cedra_framework::fungible_asset::{Self, BurnRef, FungibleAsset, TransferRef};
    ...
    #[test_only]
    use cedra_framework::fungible_asset::{Metadata, TestToken};

    #[test(creator = @0xcafe)]
    #[expected_failure(major_status=4037, location=cedra_framework::dispatchable_fungible_asset)]
