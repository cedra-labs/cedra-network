spec cedra_framework::code {
    ...
    /// Enforcement: The Cedra upgrade native functions have been manually audited.
    ///
    /// No.: 2
    ...
    spec initialize(cedra_framework: &signer, package_owner: &signer, metadata: PackageMetadata) {
