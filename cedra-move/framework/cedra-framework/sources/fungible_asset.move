...
module cedra_framework::fungible_asset {
    use cedra_framework::aggregator_v2::{Self, Aggregator};
    use cedra_framework::create_signer;
    use cedra_framework::event;
    use cedra_framework::function_info::{Self, FunctionInfo};
    use cedra_framework::object::{Self, Object, ConstructorRef, DeleteRef, ExtendRef};
    ...
    fun has_deposit_dispatch_function(metadata: Object<Metadata>): bool acquires DispatchFunctionStore {
        ...
        if(metadata_addr != @cedra_fungible_asset && exists<DispatchFunctionStore>(metadata_addr)) {
    ...
    fun has_supply_dispatch_function(metadata_addr: address): bool {
        // Short circuit on Cedra for better perf
        if (metadata_addr != @cedra_fungible_asset) {
    ...
    #[test(fx = @cedra_framework, creator = @0xcafe)]
    ...
    fun test_e2e_withdraw_limit(
        ...
        let cedra_framework = account::create_signer_for_test(@0x1);
