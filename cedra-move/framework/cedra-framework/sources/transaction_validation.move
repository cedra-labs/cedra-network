module cedra_framework::transaction_validation {
    use std::error;
    use std::features;
    use std::option;
    ...
    // Once the transaction_simulation_enhancement feature is enabled, the Cedra VM will invoke this function instead.
    ...
    fun unified_epilogue_fee(
        ...
        if (!skip_gas_payment(
            ...
            gas_payer_address
             ...
             if (transaction_fee_amount > storage_fee_refunded) {
                let burn_amount = transaction_fee_amount - storage_fee_refunded;
                transaction_fee::burn_fee_v2(gas_payer_address, burn_amount, fa_address);
                permissioned_signer::check_permission_consume(
                    &gas_payer,
                    (burn_amount as u256),
                    GasPermission {}
