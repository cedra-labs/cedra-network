...
use cedra_framework::{ReleaseOptions, ReleaseTarget};
use clap::Parser;

#[derive(Parser)]
#[clap(name = "cedra-framework", author, version, propagate_version = true)]
enum Commands {
    /// Creates an Cedra framework release for the specified target.
