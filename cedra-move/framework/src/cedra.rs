...
impl ReleaseTarget {
    ...
    pub fn packages(self) -> Vec<(&'static str, Option<&'static str>, bool)> {
        let result = vec![
            ...
            ("cedra-stdlib", None, false),
            (
                "cedra-framework",
                Some("cached-packages/src/cedra_framework_sdk_builder.rs"),
                false,
            ),
            (
                "cedra-token",
                Some("cached-packages/src/cedra_token_sdk_builder.rs"),
                false,
            ),
            (
                "cedra-token-objects",
                Some("cached-packages/src/cedra_token_objects_sdk_builder.rs"),
                false,
            ),
            ("cedra-experimental", None, true),
        ];
...
static NAMED_ADDRESSES: Lazy<BTreeMap<String, NumericalAddress>> = Lazy::new(|| {
    ...
    result.insert("cedra_std".to_owned(), one);
    result.insert("cedra_framework".to_owned(), one);
    result.insert("cedra_token".to_owned(), three);
    result.insert("cedra_token_objects".to_owned(), four);
    result.insert("cedra_experimental".to_owned(), seven);
    result.insert("cedra_fungible_asset".to_owned(), ten);
