...
module cedra_experimental::confidential_proof {
    use std::error;
    use std::option;
    use std::option::Option;
    use std::vector;
    use cedra_std::ristretto255::{Self, CompressedRistretto, Scalar};
    use cedra_std::ristretto255_bulletproofs::{Self as bulletproofs, RangeProof};

    use cedra_experimental::confidential_balance;
    use cedra_experimental::ristretto255_twisted_elgamal as twisted_elgamal;

    friend cedra_experimental::confidential_asset;
    ...
    const FIAT_SHAMIR_WITHDRAWAL_SIGMA_DST: vector<u8> = b"CedraConfidentialAsset/WithdrawalProofFiatShamir";
    const FIAT_SHAMIR_TRANSFER_SIGMA_DST: vector<u8> = b"CedraConfidentialAsset/TransferProofFiatShamir";
    const FIAT_SHAMIR_ROTATION_SIGMA_DST: vector<u8> = b"CedraConfidentialAsset/RotationProofFiatShamir";
    const FIAT_SHAMIR_NORMALIZATION_SIGMA_DST: vector<u8> = b"CedraConfidentialAsset/NormalizationProofFiatShamir";

    const BULLETPROOFS_DST: vector<u8> = b"CedraConfidentialAsset/BulletproofRangeProof";
