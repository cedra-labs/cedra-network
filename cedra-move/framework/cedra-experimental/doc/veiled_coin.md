...
This module allows users to "register" a veiled account for any pre-existing <code>cedra_framework::Coin</code> type <code>T</code> via
...
The only information that an attacker (e.g., an Cedra validator) learns, is that Alice transferred an unknown amount
<code>v</code> to Bob (including $v=0$), and as a result Alice's veiled balance is in a range [a-v, a] and Bob's veiled balance
is in [b, b+v]<code>.

As more veiled transfers occur between more veiled accounts, the uncertainity on the balance of each <a href="../../cedra-framework/doc/account.md#0x1_account">account</a> becomes
larger and larger.
...
1. *Veiled <a href="../../cedra-framework/doc/coin.md#0x1_coin">coin</a>*: a <a href="../../cedra-framework/doc/coin.md#0x1_coin">coin</a> whose value is secret; i.e., it is encrypted under the owner's <b>public</b> key.

2. *Veiled amount*: <a href="../../cedra-framework/../cedra-stdlib/doc/any.md#0x1_any">any</a> amount that is secret because it was encrypted under some <b>public</b> key.
3. *Committed amount*: <a href="../../cedra-framework/../cedra-stdlib/doc/any.md#0x1_any">any</a> amount that is secret because it was committed <b>to</b> (rather than encrypted).

4. *Veiled transaction*: a transaction that hides its amount transferred; i.e., a transaction whose amount is veiled.

5. *Veiled balance*: unlike a normal balance, a veiled balance is secret; i.e., it is encrypted under the <a href="../../cedra-framework/doc/account.md#0x1_account">account</a>'s
<b>public</b> key.
...
encryption keypair.
5. There is no support for rotating the ElGamal encryption <b>public</b> key of a veiled <a href="../../cedra-framework/doc/account.md#0x1_account">account</a>.


<a id="@Veiled_<a_href="../../cedra-framework/doc/coin.md#0x1_coin">coin</a>_amounts_<b>as</b>_truncated_</code>u32<code>'s_3"></a>

### Veiled <a href="../../cedra-framework/doc/coin.md#0x1_coin">coin</a> amounts <b>as</b> truncated </code>u32<code>'s


Veiled <a href="../../cedra-framework/doc/coin.md#0x1_coin">coin</a> amounts must be specified <b>as</b> </code>u32<code>'s rather than </code>u64<code>'s <b>as</b> would be typical for normal coins in the
Cedra framework. This is because <a href="../../cedra-framework/doc/coin.md#0x1_coin">coin</a> amounts must be encrypted <b>with</b> an *efficient*, additively-homomorphic encryption
...
Specifically, veiled <a href="../../cedra-framework/doc/coin.md#0x1_coin">coin</a> amounts are restricted <b>to</b> be 32 bits and can be cast <b>to</b> a normal 64-bit <a href="../../cedra-framework/doc/coin.md#0x1_coin">coin</a> value by
setting the leftmost and rightmost 16 bits <b>to</b> zero and the "middle" 32 bits <b>to</b> be the veiled <a href="../../cedra-framework/doc/coin.md#0x1_coin">coin</a> bits.

This gives veiled amounts ~10 bits for specifying ~3 decimals and ~22 bits for specifying whole amounts, which
limits veiled balances and veiled transfers <b>to</b> around 4 million coins. (See </code>coin.move<code> for how a normal 64-bit <a href="../../cedra-framework/doc/coin.md#0x1_coin">coin</a>
value gets interpreted <b>as</b> a decimal number.)

In order <b>to</b> convert a </code>u32<code> veiled <a href="../../cedra-framework/doc/coin.md#0x1_coin">coin</a> amount <b>to</b> a normal </code>u64<code> <a href="../../cedra-framework/doc/coin.md#0x1_coin">coin</a> amount, we have <b>to</b> shift it left by 16 bits.
...
<code><a href="../../cedra-framework/doc/cedra_coin.md#0x1_cedra_coin">cedra_coin</a>.<b>move</b></code>). This precision $d$ is used when displaying a <code>u64</code> amount, by dividing the amount by $10^d$.
...
normal <code><a href="../../cedra-framework/doc/coin.md#0x1_coin_Coin">coin::Coin</a>&lt;T&gt;</code> by transferring this latter coin into a <code><a href="../../cedra-framework/doc/coin.md#0x1_coin_CoinStore">coin::CoinStore</a>&lt;T&gt;</code> stored in the
resource account.
...
Mahdi and Boneh, Dan; in Financial Cryptography and Data Security; 2020
    ...
    -  [Veiled <a href="../../cedra-framework/doc/coin.md#0x1_coin">coin</a> amounts <b>as</b> truncated </code>u32<code>'s](#@Veiled_<a_href="../../cedra-framework/doc/coin.md#0x1_coin">coin</a>_amounts_<b>as</b>_truncated_</code>u32<code>'s_3)
...
<dl>
<dt>
<code>veiled_balance: <a href="../../cedra-framework/../cedra-stdlib/doc/ristretto255_elgamal.md#0x1_ristretto255_elgamal_CompressedCiphertext">ristretto255_elgamal::CompressedCiphertext</a></code>
</dt>
<dd>
 A ElGamal ciphertext of a value $v \in [0, 2^{32})$, an invariant that is enforced throughout the code.
</dd>
<dt>
<code>pk: <a href="../../cedra-framework/../cedra-stdlib/doc/ristretto255_elgamal.md#0x1_ristretto255_elgamal_CompressedPubkey">ristretto255_elgamal::CompressedPubkey</a></code>
</dt>
<dd>
...
Holds an <code><a href="../../cedra-framework/doc/account.md#0x1_account_SignerCapability">account::SignerCapability</a></code> for the resource account created when initializing this module. This
resource account houses a <code><a href="../../cedra-framework/doc/coin.md#0x1_coin_CoinStore">coin::CoinStore</a>&lt;T&gt;</code> for every type of coin <code>T</code> that is veiled.
...
<dl>
<dt>
<code>signer_cap: <a href="../../cedra-framework/doc/account.md#0x1_account_SignerCapability">account::SignerCapability</a></code>
</dt>
<dd>
...
<dl>
<dt>
<code>veiled_amount: <a href="../../cedra-framework/../cedra-stdlib/doc/ristretto255_elgamal.md#0x1_ristretto255_elgamal_Ciphertext">ristretto255_elgamal::Ciphertext</a></code>
</dt>
<dd>
...
<dt>
<code>zkrp_amount: <a href="../../cedra-framework/../cedra-stdlib/doc/ristretto255_bulletproofs.md#0x1_ristretto255_bulletproofs_RangeProof">ristretto255_bulletproofs::RangeProof</a></code>
</dt>
<dd>
...
Initializes a so-called "resource" account which will maintain a <code><a href="../../cedra-framework/doc/coin.md#0x1_coin_CoinStore">coin::CoinStore</a>&lt;T&gt;</code> resource for all <code>Coin&lt;T&gt;</code>'s
...
Takes a *public* <code>amount</code> of <code><a href="veiled_coin.md#0x7_veiled_coin_VeiledCoin">VeiledCoin</a>&lt;CoinType&gt;</code> coins from <code>sender</code>, unwraps them to a <code><a href="../../cedra-framework/doc/coin.md#0x1_coin_Coin">coin::Coin</a>&lt;CoinType&gt;</code>,
...
Returns the ElGamal encryption of the value of <code><a href="../../cedra-framework/doc/coin.md#0x1_coin">coin</a></code>.


<pre><code><b>public</b> <b>fun</b> <a href="veiled_coin.md#0x7_veiled_coin_veiled_amount">veiled_amount</a>&lt;CoinType&gt;(<a href="../../cedra-framework/doc/coin.md#0x1_coin">coin</a>: &<a href="veiled_coin.md#0x7_veiled_coin_VeiledCoin">veiled_coin::VeiledCoin</a>&lt;CoinType&gt;): &<a href="../../cedra-framework/../cedra-stdlib/doc/ristretto255_elgamal.md#0x1_ristretto255_elgamal_Ciphertext">ristretto255_elgamal::Ciphertext</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="veiled_coin.md#0x7_veiled_coin_veiled_amount">veiled_amount</a>&lt;CoinType&gt;(<a href="../../cedra-framework/doc/coin.md#0x1_coin">coin</a>: &<a href="veiled_coin.md#0x7_veiled_coin_VeiledCoin">VeiledCoin</a>&lt;CoinType&gt;): &elgamal::Ciphertext {
    &<a href="../../cedra-framework/doc/coin.md#0x1_coin">coin</a>.veiled_amount
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="veiled_coin.md#0x7_veiled_coin_veiled_balance">veiled_balance</a>&lt;CoinType&gt;(owner: <b>address</b>): <a href="../../cedra-framework/../cedra-stdlib/doc/ristretto255_elgamal.md#0x1_ristretto255_elgamal_CompressedCiphertext">ristretto255_elgamal::CompressedCiphertext</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="veiled_coin.md#0x7_veiled_coin_encryption_public_key">encryption_public_key</a>&lt;CoinType&gt;(addr: <b>address</b>): <a href="../../cedra-framework/../cedra-stdlib/doc/ristretto255_elgamal.md#0x1_ristretto255_elgamal_CompressedPubkey">ristretto255_elgamal::CompressedPubkey</a>
</code></pre>
...
represent normal <code>cedra_framework::coin::Coin</code> values.
...
<pre><code><b>public</b> <b>fun</b> <a href="veiled_coin.md#0x7_veiled_coin_register_internal">register_internal</a>&lt;CoinType&gt;(user: &<a href="../../cedra-framework/../cedra-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>, pk: elgamal::CompressedPubkey) {
    ...
    // value. We'd need <b>to</b> have `(r * G, v * G + r * pk) = (0_G, 0_G)`, which implies `r = 0` for <a href="../../cedra-framework/../cedra-stdlib/doc/any.md#0x1_any">any</a> choice of PK/SK.
...
Deposits a veiled <code><a href="../../cedra-framework/doc/coin.md#0x1_coin">coin</a></code> at address <code>to_addr</code>.


<pre><code><b>public</b> <b>fun</b> <a href="veiled_coin.md#0x7_veiled_coin_veiled_deposit">veiled_deposit</a>&lt;CoinType&gt;(to_addr: <b>address</b>, <a href="../../cedra-framework/doc/coin.md#0x1_coin">coin</a>: <a href="veiled_coin.md#0x7_veiled_coin_VeiledCoin">veiled_coin::VeiledCoin</a>&lt;CoinType&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="veiled_coin.md#0x7_veiled_coin_veiled_deposit">veiled_deposit</a>&lt;CoinType&gt;(to_addr: <b>address</b>, <a href="../../cedra-framework/doc/coin.md#0x1_coin">coin</a>: <a href="veiled_coin.md#0x7_veiled_coin_VeiledCoin">VeiledCoin</a>&lt;CoinType&gt;) <b>acquires</b> <a href="veiled_coin.md#0x7_veiled_coin_VeiledCoinStore">VeiledCoinStore</a> {
    ...
    elgamal::ciphertext_add_assign(&<b>mut</b> veiled_balance, &<a href="../../cedra-framework/doc/coin.md#0x1_coin">coin</a>.veiled_amount);

    // Update the veiled balance
    veiled_coin_store.veiled_balance = elgamal::compress_ciphertext(&veiled_balance);

    // Make sure the veiled <a href="../../cedra-framework/doc/coin.md#0x1_coin">coin</a> is dropped so it cannot be double spent
    <b>let</b> <a href="veiled_coin.md#0x7_veiled_coin_VeiledCoin">VeiledCoin</a>&lt;CoinType&gt; { veiled_amount: _ } = <a href="../../cedra-framework/doc/coin.md#0x1_coin">coin</a>;

    // Once successful, emit an <a href="../../cedra-framework/doc/event.md#0x1_event">event</a> that a veiled deposit occurred.
...
<pre><code><b>public</b> <b>fun</b> <a href="veiled_coin.md#0x7_veiled_coin_unveil_to_internal">unveil_to_internal</a>&lt;CoinType&gt;(
    ...
    <b>let</b> scalar_amount = <a href="../../cedra-framework/../cedra-stdlib/doc/ristretto255.md#0x1_ristretto255_new_scalar_from_u32">ristretto255::new_scalar_from_u32</a>(amount);
    ...
    // Emit <a href="../../cedra-framework/doc/event.md#0x1_event">event</a> <b>to</b> indicate a veiled withdrawal occurred
    <a href="../../cedra-framework/doc/event.md#0x1_event_emit">event::emit</a>(
        <a href="veiled_coin.md#0x7_veiled_coin_Withdraw">Withdraw</a> { user: addr },
    );

    // <a href="veiled_coin.md#0x7_veiled_coin_Withdraw">Withdraw</a> normal `Coin`'s from the resource <a href="../../cedra-framework/doc/account.md#0x1_account">account</a> and deposit them in the recipient's
    <b>let</b> c = <a href="../../cedra-framework/doc/coin.md#0x1_coin_withdraw">coin::withdraw</a>(&<a href="veiled_coin.md#0x7_veiled_coin_get_resource_account_signer">get_resource_account_signer</a>(), <a href="veiled_coin.md#0x7_veiled_coin_cast_u32_to_u64_amount">cast_u32_to_u64_amount</a>(amount));

    <a href="../../cedra-framework/doc/coin.md#0x1_coin_deposit">coin::deposit</a>&lt;CoinType&gt;(recipient, c);
}
</code></pre>
    ...
    transfer_proof: &<a href="veiled_coin.md#0x7_veiled_coin_TransferProof">TransferProof</a>) <b>acquires</b> <a href="veiled_coin.md#0x7_veiled_coin_VeiledCoinStore">VeiledCoinStore</a>
{
    ...
    // Note: The `encryption_public_key` call from above already asserts that `sender_addr` <b>has</b> a <a href="../../cedra-framework/doc/coin.md#0x1_coin">coin</a> store.
    ...
    // Fetch the veiled balance of the veiled <a href="../../cedra-framework/doc/account.md#0x1_account">account</a>
    ...
    // Update the <a href="../../cedra-framework/doc/account.md#0x1_account">account</a>'s veiled balance by homomorphically subtracting the veiled amount from the veiled balance.
    ...
    // Once everything succeeds, emit an <a href="../../cedra-framework/doc/event.md#0x1_event">event</a> <b>to</b> indicate a veiled withdrawal occurred
    <a href="../../cedra-framework/doc/event.md#0x1_event_emit">event::emit</a>(
        <a href="veiled_coin.md#0x7_veiled_coin_Withdraw">Withdraw</a> { user: sender_addr },
    );

    // Create a new veiled <a href="../../cedra-framework/doc/coin.md#0x1_coin">coin</a> for the recipient.
    <b>let</b> vc = <a href="veiled_coin.md#0x7_veiled_coin_VeiledCoin">VeiledCoin</a>&lt;CoinType&gt; { veiled_amount: veiled_deposit_amount };

    // Deposits `veiled_deposit_amount` into the recipient's <a href="../../cedra-framework/doc/account.md#0x1_account">account</a>
...
<pre><code><b>public</b> <b>fun</b> <a href="veiled_coin.md#0x7_veiled_coin_verify_range_proofs">verify_range_proofs</a>(
    ...
    // the veild <a href="../../cedra-framework/doc/coin.md#0x1_coin">coin</a> <a href="../../cedra-framework/doc/code.md#0x1_code">code</a>: i.e., that every <a href="../../cedra-framework/doc/account.md#0x1_account">account</a> <b>has</b> `new_bal \in [0, 2^{32})`.
    //
...
<pre><code><b>fun</b> <a href="veiled_coin.md#0x7_veiled_coin_veiled_mint_from_coin">veiled_mint_from_coin</a>&lt;CoinType&gt;(c: <a href="../../cedra-framework/doc/coin.md#0x1_coin_Coin">coin::Coin</a>&lt;CoinType&gt;): <a href="veiled_coin.md#0x7_veiled_coin_VeiledCoin">veiled_coin::VeiledCoin</a>&lt;CoinType&gt;
</code></pre>
...
<pre><code><b>fun</b> <a href="veiled_coin.md#0x7_veiled_coin_veiled_mint_from_coin">veiled_mint_from_coin</a>&lt;CoinType&gt;(c: Coin&lt;CoinType&gt;): <a href="veiled_coin.md#0x7_veiled_coin_VeiledCoin">VeiledCoin</a>&lt;CoinType&gt; <b>acquires</b> <a href="veiled_coin.md#0x7_veiled_coin_VeiledCoinMinter">VeiledCoinMinter</a> {
    ...
    // ...and mint a veiled <a href="../../cedra-framework/doc/coin.md#0x1_coin">coin</a>, which is backed by the normal <a href="../../cedra-framework/doc/coin.md#0x1_coin">coin</a>
