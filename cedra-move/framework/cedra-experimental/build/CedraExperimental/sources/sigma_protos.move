...
module cedra_experimental::sigma_protos {
    use std::error;
    ...
    use cedra_std::ristretto255::{Self, RistrettoPoint, Scalar};

    use cedra_experimental::helpers::cut_vector;
    ...
    const FIAT_SHAMIR_SIGMA_DST : vector<u8> = b"CedraVeiledCoin/WithdrawalSubproofFiatShamir";
