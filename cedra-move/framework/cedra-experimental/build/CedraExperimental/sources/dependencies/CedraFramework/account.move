module cedra_framework::account {
    use std::bcs;
    use std::error;
    use std::features;
    use std::hash;
    ...
    use cedra_std::multi_ed25519;
    use cedra_std::single_key;
    use cedra_std::multi_key;
    ...
    #[test_only]
    /// Create signer for testing, independently of an Cedra-style `Account`.
    ...
    public(friend) fun initialize(cedra_framework: &signer) {
        ...
        move_to(cedra_framework, OriginatingAddress {
    ...
    public fun originating_address(auth_key: address): Option<address> acquires OriginatingAddress {
        let address_map_ref = &OriginatingAddress[@cedra_framework].address_map;
    ...
    entry fun set_originating_address(account: &signer) acquires Account, OriginatingAddress {
        ...
        let address_map_ref_mut =
            &mut OriginatingAddress[@cedra_framework].address_map;
    ...
    fun update_auth_key_and_originating_address_table(
        ...
        let address_map = &mut OriginatingAddress[@cedra_framework].address_map;
    ...
    /// `create_account` to attempt to claim an account ahead of the creation of a resource account, if found Cedra will
    ...
    fun test_create_signer_for_test() {
        assert!(signer::address_of(&create_signer_for_test(@cedra_framework)) == @0x1, 0);
    ...
    #[test(alice = @0xa11ce)]
    #[expected_failure(abort_code = 65537, location = cedra_framework::ed25519)]
    ...
    //
    #[test(bob = @0x345, framework = @cedra_framework)]
    ...
    #[test(bob = @0x345, charlie = @0x567, framework = @cedra_framework)]
    ...
    public entry fun test_valid_rotate_authentication_key_multi_ed25519_to_multi_ed25519(
        ...
        let address_map = &OriginatingAddress[@cedra_framework].address_map;
