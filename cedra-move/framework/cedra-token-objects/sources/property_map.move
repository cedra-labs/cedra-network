/// `PropertyMap` provides generic metadata support for `CedraToken`. It is a specialization of
...
module cedra_token_objects::property_map {
    use std::bcs;
    use std::error;
    ...
    use cedra_framework::object::{Self, ConstructorRef, Object, ExtendRef, ObjectCore};
    ...
    #[test(creator = @0x123)]
    #[expected_failure(abort_code = 0x10001, location = cedra_std::from_bcs)]
