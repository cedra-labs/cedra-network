...
module cedra_std::ristretto255_bulletproofs {
    use std::error;
    use std::features;
    use cedra_std::ristretto255_pedersen as pedersen;
    use cedra_std::ristretto255::{Self, RistrettoPoint};
    ...
    #[test_only]
    use cedra_std::ristretto255::{Scalar, scalar_to_bytes};
    #[test_only]
    use cedra_std::ristretto255_pedersen::commitment_equals;

    #[test_only]
    const A_DST: vector<u8> = b"CedraBulletproofs";
    #[test_only]
