...
module cedra_framework::object_code_deployment {
    use std::bcs;
    use std::error;
    use std::features;
    use std::signer;
    ...
    use cedra_framework::code::PackageRegistry;
    use cedra_framework::event;
    use cedra_framework::object;
    use cedra_framework::object::{ExtendRef, Object};
    ...
    const OBJECT_CODE_DEPLOYMENT_DOMAIN_SEPARATOR: vector<u8> = b"cedra_framework::object_code_deployment";
