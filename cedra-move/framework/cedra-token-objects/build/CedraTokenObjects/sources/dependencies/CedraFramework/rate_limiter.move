module cedra_framework::rate_limiter {
    ...
    fun test_initialize_bucket(cedra_framework: &signer) {
    ...
    #[test(cedra_framework = @0x1)]
    fun test_request_success(cedra_framework: &signer) {
        timestamp::set_time_has_started_for_testing(cedra_framework);
    ...
    #[test(cedra_framework = @0x1)]
    fun test_request_failure(cedra_framework: &signer) {
        timestamp::set_time_has_started_for_testing(cedra_framework);
        let bucket = initialize(10, 30);
    ...
    #[test(cedra_framework = @0x1)]
    fun test_refill(cedra_framework: &signer) {
        timestamp::set_time_has_started_for_testing(cedra_framework);
        let bucket = initialize(10, 60);
    ...
    #[test(cedra_framework= @0x1)]
    fun test_fractional_accumulation(cedra_framework: &signer) {
        timestamp::set_time_has_started_for_testing(cedra_framework);
        let bucket = initialize(10, 60);
    ...
    #[test(cedra_framework= @0x1)]
    fun test_multiple_refills(cedra_framework: &signer) {
        timestamp::set_time_has_started_for_testing(cedra_framework);
        let bucket = initialize(10, 60);
