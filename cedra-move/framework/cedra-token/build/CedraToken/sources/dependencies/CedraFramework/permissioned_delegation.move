module cedra_framework::permissioned_delegation {
    use std::error;
    ...
    use cedra_framework::permissioned_signer::{Self, is_permissioned_signer, StorablePermissionedHandle};
    use cedra_framework::rate_limiter;
    use cedra_framework::rate_limiter::RateLimiter;
    #[test_only]
    use std::bcs;
    #[test_only]
    use std::option;
    ...
    #[test_only]
    use cedra_std::ed25519::{sign_arbitrary_bytes, generate_keys, validated_public_key_to_bytes, Signature,
    ...
    fun test_basics(account: signer, account_copy: signer) acquires RegisteredDelegations {
        let cedra_framework = create_signer_for_test(@cedra_framework);
