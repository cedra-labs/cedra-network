...
module cedra_framework::code {
    ...
    friend cedra_framework::object_code_deployment;
    ...
    fun initialize(cedra_framework: &signer, package_owner: &signer, metadata: PackageMetadata)
