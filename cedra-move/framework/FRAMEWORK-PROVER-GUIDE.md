This guide gives some hints to troubleshoot issues when using the prover for specifying the Cedra frameworks.

## Installation

Please refer to the [doc](https://cedra.dev/tools/cedra-cli/install-cli/install-move-prover/).
...
you could use the command `cargo test --release -p cedra-framework -- --skip prover`.


## Specification guide

Please refer to the [Move Prover Book](https://cedra.dev/guides/prover-guides/move-prover)
