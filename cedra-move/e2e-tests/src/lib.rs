...
//! Test infrastructure for the Cedra VM.
//!
//! This crate contains helpers for executing tests against the Cedra VM.

use cedra_types::{transaction::TransactionStatus, vm_status::KeptVMStatus};
