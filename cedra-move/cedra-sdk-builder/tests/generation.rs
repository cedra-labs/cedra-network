...
use cedra_sdk_builder as buildgen;
...
fn get_cedra_registry() -> Registry {
    let path = "../../testsuite/generate-format/tests/staged/cedra.yaml";
...
[dependencies]
cedra-types = {{ path = "../cedra-types", version = "0.1.0" }}
serde_bytes = "0.11.6"
...
fn test_that_rust_entry_fun_code_compiles() {
    ...
    let abis = vec![];
    test_rust(
        &abis, // &cedra_cached_packages::head_release_bundle().abis(),
