...
module cedra_std::single_key {
    use cedra_std::bcs_stream::{Self, deserialize_u8};
    use cedra_std::ed25519;
    use cedra_std::keyless;
    use cedra_std::secp256k1;
    use cedra_std::secp256r1;
    use cedra_std::bcs;
    use cedra_std::federated_keyless;
    use std::error;
    use std::hash;
    ...
    /// The identifier of the Single Key signature scheme, which is used when deriving Cedra authentication keys by hashing
