...
module cedra_framework::optional_aggregator {
    use std::error;
    use std::option::{Self, Option};

    use cedra_framework::aggregator_factory;
    use cedra_framework::aggregator::{Self, Aggregator};
    ...
    #[test(account = @cedra_framework)]
    #[expected_failure(abort_code = 0x020001, location = cedra_framework::aggregator)]
    ...
    #[test(account = @cedra_framework)]
    #[expected_failure(abort_code = 0x020002, location = cedra_framework::aggregator)]
