module cedra_framework::staking_proxy {
    use std::error;
    use std::signer;
    use std::vector;
    ...
    public entry fun test_set_operator(
        ...
        vesting::setup(
            cedra_framework, &vector[owner_address, operator_1_address, operator_2_address, new_operator_address]);
        staking_contract::setup_staking_contract(cedra_framework, owner, operator_1, INITIAL_BALANCE, 0);
        staking_contract::setup_staking_contract(cedra_framework, owner, operator_2, INITIAL_BALANCE, 0);
    ...
    public entry fun test_set_voter(
        ...
        vesting::setup(
            cedra_framework, &vector[owner_address, operator_1_address, operator_2_address, new_voter_address]);
        staking_contract::setup_staking_contract(cedra_framework, owner, operator_1, INITIAL_BALANCE, 0);
        staking_contract::setup_staking_contract(cedra_framework, owner, operator_2, INITIAL_BALANCE, 0);
