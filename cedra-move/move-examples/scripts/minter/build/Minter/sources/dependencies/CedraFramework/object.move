...
module cedra_framework::object {
    ...
    fun test_correct_auid() {
        let auid1 = cedra_framework::transaction_context::generate_auid_address();
        let bytes = cedra_framework::transaction_context::get_transaction_hash();
        ...
        let auid2 = cedra_framework::from_bcs::to_address(std::hash::sha3_256(bytes));
