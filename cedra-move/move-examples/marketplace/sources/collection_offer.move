...
module collection_offer {
    ...
    inline fun cleanup<CoinType>(
        ...
        cedra_account::deposit_coins(object::owner(collection_offer), coins);
...
module collection_offer_tests {
    ...
    use cedra_token_objects::collection as collectionv2;
    ...
    #[test(cedra_framework = @0x1, marketplace = @0x111, seller = @0x222, purchaser = @0x333)]
    #[expected_failure(abort_code = 0x50004, location = cedra_framework::object)]
