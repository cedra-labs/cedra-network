...
module token_offer {
    ...
    inline fun init_coin_holder<CoinType>(
        ...
        cedra_account::transfer_coins<CoinType>(purchaser, fee_address, fee);
    ...
    inline fun settle_payments<CoinType>(
        ...
        cedra_account::deposit_coins(royalty_payee, royalties);
    ...
    inline fun cleanup<CoinType>(
        ...
        cedra_account::deposit_coins(object::owner(token_offer), coins);
...
module token_offer_tests {
    ...
    fun test_token_v2(
        ...
        let token_offer = token_offer::init_for_tokenv2<CedraCoin>(
            purchaser,
            token,
        ...
        assert!(coin::balance<CedraCoin>(purchaser_addr) == 9499, 0);
        assert!(coin::balance<CedraCoin>(seller_addr) == 10000, 0);

        token_offer::sell_tokenv2<CedraCoin>(seller, token_offer);
    ...
    fun test_token_v1_direct_deposit(
        ...
        let token_offer = token_offer::init_for_tokenv1<CedraCoin>(
            purchaser,
            creator_addr,
            collection_name,
            token_name,
        ...
        token_offer::sell_tokenv1<CedraCoin>(seller, token_offer, token_name, property_version);
        assert!(coin::balance<CedraCoin>(marketplace_addr) == 6, 0);
        assert!(coin::balance<CedraCoin>(purchaser_addr) == 9499, 0);
        assert!(coin::balance<CedraCoin>(seller_addr) == 10495, 0);
    ...
    fun test_token_v1_indirect(
        ...
        let token_container = token_offer::sell_tokenv1<CedraCoin>(
            seller,
            token_offer,
            token_name,
            property_version,
    ...
    fun test_token_v2_has_none(
        ...
        token_offer::sell_tokenv2<CedraCoin>(marketplace, token_offer);
    }

    #[test(cedra_framework = @0x1, marketplace = @0x111, seller = @0x222, purchaser = @0x333)]
    #[expected_failure(abort_code = 0x10005, location = cedra_token::token)]
    fun test_token_v1_has_none(
        ...
        token_offer::sell_tokenv1<CedraCoin>(
            marketplace,
            token_offer,
            token_name,
            property_version,
    ...
    fun test_token_v2_exhausted(
        ...
        token_offer::sell_tokenv2<CedraCoin>(seller, token_offer);
        token_offer::sell_tokenv2<CedraCoin>(purchaser, token_offer);
    }
