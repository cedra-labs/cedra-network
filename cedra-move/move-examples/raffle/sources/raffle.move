...
module raffle::raffle {
    ...
    struct Raffle has key {
        ...
        // See [AIP-41](https://github.com/cedra-foundation/AIPs/blob/main/aips/aip-41.md#undergasing-attacks).
    ...
    /// [AIP-41](https://github.com/cedra-foundation/AIPs/blob/main/aips/aip-41.md)).
    ...
    /// **test-and-abort** attacks (see [AIP-41](https://github.com/cedra-foundation/AIPs/blob/main/aips/aip-41.md)).
    ///
