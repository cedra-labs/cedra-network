...
module example_addr::managed_fungible_asset {
    use cedra_framework::fungible_asset::{Self, MintRef, TransferRef, BurnRef, Metadata, FungibleStore, FungibleAsset};
    ...
    #[test_only]
    use cedra_framework::object::object_from_constructor_ref;
    #[test_only]
    use std::string::utf8;
    use std::vector;
    ...
    fun create_test_mfa(creator: &signer): Object<Metadata> {
        let constructor_ref = &object::create_named_object(creator, b"Cedra");
        initialize(
            constructor_ref,
            0,
            utf8(b"Cedra Token"), /* name */
            utf8(b"Cedra"), /* symbol */
            8, /* decimals */
