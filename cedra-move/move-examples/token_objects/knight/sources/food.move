...
module knight::food {
    ...
    fun init_module(sender: &signer) {
        ...
        create_food_token_as_fungible_token(
            ...
            string::utf8(b"https://raw.githubusercontent.com/cedra-labs/cedra-network/main/ecosystem/typescript/sdk/examples/typescript/metadata/knight/Corn"),
            string::utf8(b"Corn"),
            string::utf8(b"CORN"),
            string::utf8(b"https://raw.githubusercontent.com/cedra-labs/cedra-network/main/ecosystem/typescript/sdk/examples/typescript/metadata/knight/Corn.png"),
            string::utf8(b"https://cedra.network"),
            5,
        );
        create_food_token_as_fungible_token(
            sender,
            ...
            string::utf8(b"https://raw.githubusercontent.com/cedra-labs/cedra-network/main/ecosystem/typescript/sdk/examples/typescript/metadata/knight/Meat"),
            string::utf8(b"Meat"),
            string::utf8(b"MEAT"),
            string::utf8(b"https://raw.githubusercontent.com/cedra-labs/cedra-network/main/ecosystem/typescript/sdk/examples/typescript/metadata/knight/Meat.png"),
            string::utf8(b"https://cedra.network"),
            20,
        );
    }
