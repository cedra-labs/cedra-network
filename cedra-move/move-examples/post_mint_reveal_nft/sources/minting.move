...
// cedra move publish --named-addresses post_mint_reveal_nft=[address of your admin_account]
...
module post_mint_reveal_nft::minting {
    ...
    public entry fun set_treasury(admin: &signer, new_treasury_address: address) acquires NFTMintConfig {
        ...
        cedra_account::assert_account_is_registered_for_cedra(new_treasury_address);
    ...
    public fun set_up_test(
        ...
        let (burn_cap, mint_cap) = cedra_framework::cedra_coin::initialize_for_test(cedra_framework);
    ...
    public entry fun test_happy_path(
        ...
        set_up_test(&admin_account, &wl_nft_claimer, &public_nft_claimer, &treasury_account, &cedra_framework, 10, 0);
    ...
    public entry fun test_adding_token_uris_exceeds_collection_maximum(
        ...
        set_up_test(&admin_account, &wl_nft_claimer, &public_nft_claimer, &treasury_account, &cedra_framework, 10, 2);
        set_public_minting_and_reveal_config(&admin_account, 201, 400, 10, 400);
        set_up_whitelist_stage(&admin_account, 50, 200, 5, 0);
        let wl_addresses = vector::empty<address>();
        vector::push_back(&mut wl_addresses, signer::address_of(&wl_nft_claimer));
    ...
    public entry fun test_minting_source_certificate_exceeds_collection_maximum(
        ...
        set_up_test(&admin_account, &wl_nft_claimer, &public_nft_claimer, &treasury_account, &cedra_framework, 10, 3);
        set_public_minting_and_reveal_config(&admin_account, 201, 400, 10, 400);
        set_up_whitelist_stage(&admin_account, 50, 200, 5, 0);
        let wl_addresses = vector::empty<address>();
        vector::push_back(&mut wl_addresses, signer::address_of(&wl_nft_claimer));
    ...
    public entry fun set_up_multi_stage_whitelist_test(
        ...
        set_up_test(&admin_account, wl_nft_claimer, wl_nft_claimer2, &treasury_account, &cedra_framework, 10, 0);
