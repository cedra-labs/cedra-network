...
use cedra_types::state_store::StateView;
use cedra_vm::data_cache::get_resource_group_member_from_metadata;
...
pub struct CedraValueAnnotator<'a, S>(MoveValueAnnotator<ModuleView<'a, S>>);

impl<'a, S: StateView> CedraValueAnnotator<'a, S> {
