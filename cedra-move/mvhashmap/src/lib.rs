...
use cedra_types::{
    executable::ModulePath, vm::modules::CedraModuleExtension, write_set::TransactionWrite,
};
...
pub struct MVHashMap<K, T, V: TransactionWrite, I: Clone> {
    ...
    module_cache:
        SyncModuleCache<ModuleId, CompiledModule, Module, CedraModuleExtension, Option<TxnIndex>>,
