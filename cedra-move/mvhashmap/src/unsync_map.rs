...
use anyhow::anyhow;
use cedra_aggregator::types::DelayedFieldValue;
use cedra_types::{
...
use cedra_vm_types::{resolver::ResourceGroupSize, resource_group_adapter::group_size_as_sum};
...
> {
    ...
    module_cache:
        UnsyncModuleCache<ModuleId, CompiledModule, Module, CedraModuleExtension, Option<TxnIndex>>,
    ...
    > UnsyncMap<K, T, V, I>
{
    ...
    fn insert_group_op(
        ...
        use cedra_types::write_set::WriteOpKind::*;
