...
use cedra_types::state_store::state_value::StateValueMetadata;
...
/// Represents module storage used by the Cedra blockchain.
pub trait CedraModuleStorage: ModuleStorage {
