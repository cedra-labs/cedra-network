...
//! This module defines the gas parameters for Cedra Framework & Stdlib.
...
crate::gas_schedule::macros::define_gas_parameters!(
    CedraFrameworkGasParameters,
    "cedra_framework",
    NativeGasParameters => .cedra_framework,
    [
        ...
        // These are dummy value, they copied from storage gas in cedra-network/cedra-vm/src/cedra_vm_impl.rs
