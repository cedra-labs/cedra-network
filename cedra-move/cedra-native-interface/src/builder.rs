...
use cedra_gas_schedule::{MiscGasParameters, NativeGasParameters, ToOnChainGasSchedule};
use cedra_types::on_chain_config::{Features, TimedFeatures};
use bytes::Bytes;
...
impl SafeNativeBuilder {
    ...
    ///
    /// The closure will have access to the common Cedra configurations (features, gas params etc.),
