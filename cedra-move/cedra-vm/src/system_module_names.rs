...
//! Names of modules, functions, and types used by Cedra System.

use cedra_types::account_config;
...
/// The ModuleId for the cedra block module
...
pub static PRICES_STORAGE_MODULE: Lazy<ModuleId> = Lazy::new(|| {
    ModuleId::new(
        account_config::CORE_CODE_ADDRESS,
...
pub const SET_PRICE: &IdentStr = ident_str!("set_price");
