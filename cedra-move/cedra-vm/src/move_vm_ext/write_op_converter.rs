...
use crate::move_vm_ext::{session::BytesWithResourceLayout, CedraMoveResolver};
use cedra_aggregator::delta_change_set::serialize;
use cedra_types::{
...
pub(crate) struct WriteOpConverter<'r> {
    remote: &'r dyn CedraMoveResolver,
...
mod tests {
    ...
    use cedra_vm_types::{
        module_and_script_storage::AsCedraCodeStorage,
    ...
    // TODO: Can re-use some of these testing definitions with cedra-vm-types.
