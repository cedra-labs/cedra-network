...
use crate::{
    ...
    move_vm_ext::{
        resource_state_key, write_op_converter::WriteOpConverter, CedraMoveResolver, SessionId,
    },
};
use cedra_framework::natives::{
...
use cedra_table_natives::{NativeTableContext, TableChangeSet};
use cedra_types::{
