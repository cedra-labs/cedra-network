...
//! MoveVM and Session wrapped, to make sure Cedra natives and extensions are always installed and
...
pub use crate::move_vm_ext::{
    resolver::{CedraMoveResolver, AsExecutorView, AsResourceGroupView, ResourceGroupResolver},
...
pub use cedra_types::transaction::user_transaction_context::UserTransactionContext;
