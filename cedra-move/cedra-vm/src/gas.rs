...
use crate::{move_vm_ext::CedraMoveResolver, transaction_metadata::TransactionMetadata};
use cedra_gas_algebra::{Gas, GasExpression, InternalGas};
use cedra_gas_meter::{StandardGasAlgebra, StandardGasMeter};
use cedra_gas_schedule::{
    gas_feature_versions::RELEASE_V1_13, gas_params::txn::KEYLESS_BASE_COST, CedraGasParameters,
    VMGasParameters,
};
use cedra_logger::{enabled, Level};
use cedra_memory_usage_tracker::MemoryTrackedGasMeter;
use cedra_types::on_chain_config::Features;
use cedra_vm_logging::{log_schema::AdapterLogSchema, speculative_log, speculative_warn};
use cedra_vm_types::{
...
pub(crate) fn check_gas(
    ...
    if crate::cedra_vm::should_create_account_resource(
        txn_metadata,
        features,
        resolver,
        module_storage,
