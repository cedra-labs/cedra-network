...
use cedra_vm_logging::{flush_speculative_logs, init_speculative_logs};
use cedra_vm_types::{
...
use vm_wrapper::CedraExecutorTask;
...
#[derive(Debug)]
pub struct CedraTransactionOutput {
...
impl BlockExecutorTransactionOutput for CedraTransactionOutput {
...
pub struct CedraBlockExecutorWrapper<
    E: ExecutorTask<
        Txn = SignatureVerifiedTransaction,
        Error = VMStatus,
        Output = CedraTransactionOutput,
    >,
> {
...
impl<
        E: ExecutorTask<
            ...
            Output = CedraTransactionOutput,
        >,
    > CedraBlockExecutorWrapper<E>
{
    pub fn execute_block_on_thread_pool<
        S: StateView + Sync,
        L: TransactionCommitHook<Output = CedraTransactionOutput>,
...
// Same as CedraBlockExecutorWrapper with CedraExecutorTask
pub type CedraVMBlockExecutorWrapper = CedraBlockExecutorWrapper<CedraExecutorTask>;
