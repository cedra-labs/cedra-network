...
use crate::move_vm_ext::{
    resource_state_key, CedraMoveResolver, AsExecutorView, AsResourceGroupView,
...
use cedra_vm_environment::gas::get_gas_feature_version;
use cedra_vm_types::{
    resolver::{
...
/// Adapter to convert a `ExecutorView` into a `CedraMoveResolver`.
///
...
impl<'e, E: ExecutorView> CedraMoveResolver for StorageAdapter<'e, E> {}
...
/// Converts `StateView` into `CedraMoveResolver`.
...
pub(crate) mod tests {
    use super::*;
    use cedra_vm_types::resource_group_adapter::GroupSizeKind;
