...
#[cfg(feature = "testing")]
use cedra_aggregator::resolver::TAggregatorV1View;
#[cfg(feature = "testing")]
use cedra_aggregator::{bounded_math::SignedU128, types::DelayedFieldsSpeculativeError};
#[cfg(feature = "testing")]
use cedra_aggregator::{resolver::TDelayedFieldView, types::DelayedFieldValue};
#[cfg(feature = "testing")]
use cedra_framework::natives::randomness::RandomnessContext;
#[cfg(feature = "testing")]
use cedra_framework::natives::{cryptography::algebra::AlgebraContext, event::NativeEventContext};
...
#[cfg(feature = "testing")]
use cedra_table_natives::{TableHandle, TableResolver};
use cedra_types::on_chain_config::{Features, TimedFeatures, TimedFeaturesBuilder};
#[cfg(feature = "testing")]
use cedra_types::{
    chain_id::ChainId,
...
use cedra_vm_environment::natives::cedra_natives_with_builder;
#[cfg(feature = "testing")]
use bytes::Bytes;
#[cfg(feature = "testing")]
...
#[cfg(feature = "testing")]
struct CedraBlankStorage;

#[cfg(feature = "testing")]
impl CedraBlankStorage {
    pub fn new() -> Self {
        Self {}
    }
}
...
#[cfg(feature = "testing")]
impl TAggregatorV1View for CedraBlankStorage {
...
#[cfg(feature = "testing")]
impl TDelayedFieldView for CedraBlankStorage {
...
#[cfg(feature = "testing")]
impl TableResolver for CedraBlankStorage {
...
static DUMMY_RESOLVER: Lazy<CedraBlankStorage> = Lazy::new(|| CedraBlankStorage::new());

pub fn cedra_natives(
    ...
    cedra_natives_with_builder(&mut builder, false)
}
...
fn unit_test_extensions_hook(exts: &mut NativeContextExtensions) {
    use cedra_framework::natives::object::NativeObjectContext;
    use cedra_table_natives::NativeTableContext;
