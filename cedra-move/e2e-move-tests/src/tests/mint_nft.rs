...
fn mint_nft_e2e() {
    ...
    let result = h.run_transaction_payload(
        &acc,
        cedra_cached_packages::cedra_stdlib::resource_account_create_resource_account_and_publish_package(
            vec![],
...
/// in `cedra-move/move-examples/mint_nft/4-Getting-Production-Ready/sources/create_nft_getting_production_ready.move`. åååååååå
#[test]
