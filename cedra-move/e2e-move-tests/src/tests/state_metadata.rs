...
fn test_metadata_tracking() {
    ...
    let coin_store = parse_struct_tag("0x1::coin::CoinStore<0x1::cedra_coin::CedraCoin>").unwrap();
    ...
    harness.run_transaction_payload(
        &account1,
        cedra_cached_packages::cedra_stdlib::cedra_account_transfer(address2, 100),
    );
    ...
    harness.run_transaction_payload(
        &account1,
        cedra_cached_packages::cedra_stdlib::cedra_account_transfer(address3, 100),
    );
