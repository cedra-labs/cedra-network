...
use crate::traits::{CedraGasMeter, GasAlgebra};
use cedra_gas_algebra::{Fee, FeePerGasUnit, NumTypeNodes};
...
/// The official gas meter used inside the Cedra VM.
...
impl<A> CedraGasMeter for StandardGasMeter<A>
where
    A: GasAlgebra,
{
    type Algebra = A;
