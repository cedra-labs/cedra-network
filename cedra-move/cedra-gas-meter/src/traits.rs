...
use cedra_gas_algebra::{Fee, FeePerGasUnit, Gas, GasExpression, GasScalingFactor, Octa};
use cedra_gas_schedule::{gas_feature_versions::RELEASE_V1_30, VMGasParameters};
use cedra_types::{
...
/// Trait representing a gas meter used inside the Cedra VM.
///
/// It extends Move VM's `GasMeter` trait with a few Cedra-specific callbacks, along with
/// some primitives that would allow gas meters to be composable.
pub trait CedraGasMeter: MoveGasMeter {
