...
use cedra_gas_algebra::{Fee, FeePerGasUnit, Gas, GasExpression, NumBytes, NumModules, Octa};
use cedra_gas_schedule::{gas_feature_versions, VMGasParameters};
    ...
    T: BlockSynchronizationKillSwitch,
{
    ...
    fn charge_storage_fee(
        ...
        // Because the storage fees are defined in terms of fixed Cedra costs, we need
