...
/// Builds and returns all Cedra native functions.
pub fn cedra_natives_with_builder(
    ...
    cedra_move_stdlib::natives::all_natives(CORE_CODE_ADDRESS, builder)
        .into_iter()
        ...
        .chain(cedra_framework::natives::all_natives(
            CORE_CODE_ADDRESS,
            builder,
            inject_create_signer_for_gov_sim,
        ))
        .chain(cedra_table_natives::table_natives(
            CORE_CODE_ADDRESS,
            builder,
        ))
        .collect()
