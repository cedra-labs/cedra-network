...
/// Returns [TypeBuilder] used by the Cedra blockchain in production.
pub fn cedra_prod_ty_builder(
    gas_feature_version: u64,
    gas_params: &CedraGasParameters,
) -> TypeBuilder {
...
pub fn cedra_default_ty_builder() -> TypeBuilder {
    TypeBuilder::with_limits(128, 20)
}

/// Returns [DeserializerConfig] used by the Cedra blockchain in production.
pub fn cedra_prod_deserializer_config(features: &Features) -> DeserializerConfig {
...
/// Returns [VerifierConfig] used by the Cedra blockchain in production.
pub fn cedra_prod_verifier_config(features: &Features) -> VerifierConfig {
...
/// Returns [VMConfig] used by the Cedra blockchain in production, based on the set of feature
/// flags.
pub fn cedra_prod_vm_config(
    gas_feature_version: u64,
    features: &Features,
    ...
    let deserializer_config = cedra_prod_deserializer_config(features);
    let verifier_config = cedra_prod_verifier_config(features);
