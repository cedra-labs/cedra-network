...
pub struct RosettaContext {
    ...
    rest_client: Option<Arc<cedra_rest_client::Client>>,
...
impl RosettaContext {
    ...
    fn rest_client(&self) -> ApiResult<Arc<cedra_rest_client::Client>> {
...
pub fn bootstrap(
    ...
    rest_client: Option<cedra_rest_client::Client>,
    supported_currencies: HashSet<Currency>,
) -> anyhow::Result<tokio::runtime::Runtime> {
    let runtime = cedra_runtimes::spawn_named_runtime("rosetta".into(), None);
