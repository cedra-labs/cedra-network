...
use cedra_types::event::EventHandle;
use serde::{Deserialize, Serialize};

pub const ACCOUNT_MODULE: &str = "account";
pub const CEDRA_ACCOUNT_MODULE: &str = "cedra_account";
pub const CEDRA_COIN_MODULE: &str = "cedra_coin";
...
pub const CEDRA_COIN_RESOURCE: &str = "CedraCoin";
