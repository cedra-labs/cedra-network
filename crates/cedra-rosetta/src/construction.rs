...
async fn construction_derive(
    ...
    // Cedra Ed25519 authentication scheme
    let public_key: Ed25519PublicKey =
...
///
/// Only the original Ed25519 accounts on Cedra are supported
///
...
async fn simulate_transaction(
    ...
    let mut transaction_factory = TransactionFactory::new(chain_id, AccountAddress::ZERO);
        ...
        TransactionPayload::EntryFunction(inner) => {
            ...
            match (
                *module.address(),
                ...
                (AccountAddress::ONE, CEDRA_ACCOUNT_MODULE, CREATE_ACCOUNT_FUNCTION) => {
...
/// Parses 0x1::cedra_account::create(auth_key: address)
...
/// Parses 0x1::cedra_account::transfer(receiver: address, amount: u64)
...
async fn construction_payloads(
    ...
    let transaction_factory = TransactionFactory::new(server_context.chain_id, AccountAddress::ZERO)
