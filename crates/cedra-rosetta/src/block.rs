...
async fn build_block(
    ...
    block: cedra_rest_client::cedra_api_types::BcsBlock,
    chain_id: ChainId,
...
async fn get_block_by_index(
    ...
    BlockIdentifier,
    cedra_rest_client::cedra_api_types::BcsBlock,
)> {
...
pub struct BlockRetriever {
    page_size: u16,
    rest_client: Arc<cedra_rest_client::Client>,
}

impl BlockRetriever {
    pub fn new(page_size: u16, rest_client: Arc<cedra_rest_client::Client>) -> Self {
        BlockRetriever {
            page_size,
            rest_client,
        }
    ...
    ) -> ApiResult<cedra_rest_client::cedra_api_types::BcsBlock> {
