...
const CEDRA_ADDRESS: AccountAddress = AccountAddress::TEN;
...
fn test_transaction(
    ...
    TransactionOnChainData {
        version,
        transaction: cedra_types::transaction::Transaction::UserTransaction(
            cedra_types::transaction::SignedTransaction::new(
