...
pub fn derive(input: TokenStream) -> TokenStream {
    ...
    let from_serde = quote! { ::cedra_logger::Value::from_serde };
    let from_display = quote! { ::cedra_logger::Value::from_display };
    let from_debug = quote! { ::cedra_logger::Value::from_debug };
    let key_new = quote! { ::cedra_logger::Key::new };
    ...
    let expanded = quote! {
        ...
        impl #impl_generics ::cedra_logger::Schema for #name #ty_generics #where_clause {
            fn visit(&self, visitor: &mut dyn ::cedra_logger::Visitor) {
                #(#visits)*
            }
        }
    };
