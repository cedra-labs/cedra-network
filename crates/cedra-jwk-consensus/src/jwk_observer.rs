...
use cedra_jwk_utils::{fetch_jwks_from_jwks_uri, fetch_jwks_uri_from_openid_config};
use cedra_logger::{debug, info};
use cedra_types::jwks::{jwk::JWK, Issuer};
...
impl JWKObserver {
    pub fn spawn(
        ...
        observation_tx: cedra_channel::Sender<(), (Issuer, Vec<JWK>)>,
    ) -> Self {
