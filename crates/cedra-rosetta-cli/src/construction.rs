...
use cedra::common::types::{EncodingOptions, PrivateKeyInputOptions, ProfileOptions};
use cedra_logger::info;
use cedra_rosetta::types::{Currency, TransactionIdentifier};
...
pub struct CreateAccountCommand {
    ...
    #[clap(long, value_parser = cedra::common::types::load_account_arg)]
