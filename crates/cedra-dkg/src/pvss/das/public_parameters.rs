...
use cedra_crypto::{CryptoMaterialError, ValidCryptoMaterial, ValidCryptoMaterialStringExt};
use cedra_crypto_derive::{DeserializeKey, SerializeKey};
...
pub const DST_PVSS_PUBLIC_PARAMS: &[u8; 32] = b"CEDRA_DISTRIBUTED_RANDOMNESS_DST";
/// "Nothing up my sleeve" seed to deterministically-derive the public parameters.
pub const SEED_PVSS_PUBLIC_PARAMS: &[u8; 33] = b"CEDRA_DISTRIBUTED_RANDOMNESS_SEED";
...
impl Default for PublicParameters {
    /// Verifiably creates Cedra-specific public parameters.
    fn default() -> Self {
