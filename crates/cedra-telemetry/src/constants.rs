...
pub(crate) const ENV_CEDRA_DISABLE_TELEMETRY: &str = "CEDRA_DISABLE_TELEMETRY";
pub(crate) const ENV_CEDRA_FORCE_ENABLE_TELEMETRY: &str = "CEDRA_FORCE_ENABLE_TELEMETRY";
pub(crate) const ENV_CEDRA_DISABLE_TELEMETRY_PUSH_METRICS: &str =
    "CEDRA_DISABLE_TELEMETRY_PUSH_METRICS";
pub(crate) const ENV_CEDRA_DISABLE_TELEMETRY_PUSH_LOGS: &str = "CEDRA_DISABLE_TELEMETRY_PUSH_LOGS";
pub(crate) const ENV_CEDRA_DISABLE_TELEMETRY_PUSH_EVENTS: &str =
    "CEDRA_DISABLE_TELEMETRY_PUSH_EVENTS";
pub(crate) const ENV_CEDRA_DISABLE_PROMETHEUS_NODE_METRICS: &str =
    "CEDRA_DISABLE_PROMETHEUS_NODE_METRICS";
pub(crate) const ENV_CEDRA_DISABLE_LOG_ENV_POLLING: &str = "CEDRA_DISABLE_LOG_ENV_POLLING";
...
pub(crate) const CEDRA_GA_MEASUREMENT_ID: &str = "G-ZX4L6WPCFZ";
pub(crate) const CEDRA_GA_API_SECRET: &str = "ArtslKPTTjeiMi1n-IR39g";
...
pub(crate) const TELEMETRY_SERVICE_URL: &str = "https://telemetry.cedralabs.com";
pub(crate) const MAINNET_TELEMETRY_SERVICE_URL: &str = "https://telemetry.mainnet.cedralabs.com";
