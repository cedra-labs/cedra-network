...
use cedra_config::config::{NodeConfig, RoleType};
use cedra_crypto::{
...
use cedra_telemetry_service::types::{
...
mod tests {
    ...
    use super::*;
    use crate::metrics::{CEDRA_TELEMETRY_SERVICE_FAILURE, CEDRA_TELEMETRY_SERVICE_SUCCESS};
