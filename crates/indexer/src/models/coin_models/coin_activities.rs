...
const GAS_FEE_EVENT: &str = "0x1::cedra_coin::GasFeeEvent";
...
impl CoinActivity {
    ...
    pub fn from_transaction(
        ...
        maybe_cedra_coin_info: &Option<CoinInfoQuery>,
    ) -> (
        Vec<Self>,
        Vec<CoinBalance>,
    ...
    fn get_gas_event(
        ...
        Self {
            ...
            coin_type: CedraCoinType::type_tag().to_string(),
            amount: cedra_coin_burned,
