...
use cedra_api_types::{deserialize_from_string, Event, WriteResource};
...
impl CedraCollection {
    pub fn from_write_resource(
        ...
        if let V2TokenResource::CedraCollection(inner) =
...
pub enum V2TokenResource {
    CedraCollection(CedraCollection),
...
impl V2TokenResource {
    ...
    pub fn from_resource(
        ...
        match data_type {
            ...
            "0x4::cedra_token::CedraCollection" => {
                serde_json::from_value(data.clone()).map(|inner| Some(Self::CedraCollection(inner)))
            },
            "0x4::token::Token" => {
