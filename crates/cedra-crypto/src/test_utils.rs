...
) -> impl Strategy<Value = (EdwardsPoint, EdwardsPoint, TestCedraCrypto)> {
    (
...
pub struct TestCedraCrypto(pub String);
...
// #[cfg(any(test, feature = "fuzzing"))]
pub struct TestCedraCryptoHasher(crate::hash::DefaultHasher);
// #[cfg(any(test, feature = "fuzzing"))]
impl ::core::clone::Clone for TestCedraCryptoHasher {
    #[inline]
    fn clone(&self) -> TestCedraCryptoHasher {
        match *self {
            TestCedraCryptoHasher(ref __self_0_0) => {
                TestCedraCryptoHasher(::core::clone::Clone::clone(__self_0_0))
            },
        }
    }
}
...
// #[cfg(any(test, feature = "fuzzing"))]
impl TestCedraCryptoHasher {
    fn new() -> Self {
        let name = crate::_serde_name::trace_name::<TestCedraCrypto>()
            .expect("The `CryptoHasher` macro only applies to structs and enums");
        TestCedraCryptoHasher(crate::hash::DefaultHasher::new(name.as_bytes()))
    }
}
// #[cfg(any(test, feature = "fuzzing"))]
static TEST_CRYPTO_HASHER: crate::_once_cell::sync::Lazy<TestCedraCryptoHasher> =
    crate::_once_cell::sync::Lazy::new(TestCedraCryptoHasher::new);
// #[cfg(any(test, feature = "fuzzing"))]
impl std::default::Default for TestCedraCryptoHasher {
    fn default() -> Self {
        TEST_CRYPTO_HASHER.clone()
    }
}
// #[cfg(any(test, feature = "fuzzing"))]
impl crate::hash::CryptoHasher for TestCedraCryptoHasher {
...
// #[cfg(any(test, feature = "fuzzing"))]
impl std::io::Write for TestCedraCryptoHasher {
...
// #[cfg(any(test, feature = "fuzzing"))]
impl crate::hash::CryptoHash for TestCedraCrypto {
    type Hasher = TestCedraCryptoHasher;

    fn hash(&self) -> crate::hash::HashValue {
        use crate::hash::CryptoHasher;
        let mut state = Self::Hasher::default();
        bcs::serialize_into(&mut state, &self)
            .expect("BCS serialization of TestCedraCrypto should not fail");
        state.finish()
    }
}

/// Produces a random TestCedraCrypto signable / verifiable struct.
#[cfg(any(test, feature = "fuzzing"))]
pub fn random_serializable_struct() -> impl Strategy<Value = TestCedraCrypto> {
    (String::arbitrary()).prop_map(TestCedraCrypto).no_shrink()
}
