...
//!
//! ```
//! use cedra_crypto::{x25519, Uniform, test_utils::TEST_SEED};
...
//! use cedra_crypto::traits::ValidCryptoMaterialStringExt;
//! # fn main() -> Result<(), cedra_crypto::traits::CryptoMaterialError> {
