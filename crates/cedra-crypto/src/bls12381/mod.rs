...
//! ```
//! use std::iter::zip;
//! use cedra_crypto::test_utils::{KeyPair, TestCedraCrypto};
//! use cedra_crypto::{bls12381, Signature, SigningKey, Uniform};
//! use cedra_crypto::bls12381::bls12381_keys::{PrivateKey, PublicKey};
//! use cedra_crypto::bls12381::ProofOfPossession;
//! use cedra_crypto_derive::{CryptoHasher, BCSCryptoHash};
//! use rand_core::OsRng;
...
//! //
//! // Here, we'll sign an existing testing struct from `crates/cedra-crypto/src/test_utils.rs`:
//! //
...
//! let message = TestCedraCrypto("test".to_owned());
...
//! use cedra_crypto::{bls12381, Signature, SigningKey, Uniform};
//! use cedra_crypto::bls12381::bls12381_keys::{PrivateKey, PublicKey};
//! use cedra_crypto::bls12381::{ProofOfPossession, UnvalidatedPublicKey};
//! use cedra_crypto_derive::{CryptoHasher, BCSCryptoHash};
//! use rand_core::OsRng;
//! use serde::{Serialize, Deserialize};
//! use cedra_crypto::validatable::Validatable;
//!
//! // NOTE: These were generated by running `cargo test -- doc_test --ignored --nocapture` in `crates/cedra-crypto/`
...
//! // signature on TestCedraCrypto("test".to_owned())
...
//! ```
//! use std::iter::zip;
//! use cedra_crypto::test_utils::KeyPair;
//! use cedra_crypto::{bls12381, Signature, SigningKey, Uniform};
//! use cedra_crypto::bls12381::bls12381_keys::{PrivateKey, PublicKey};
//! use cedra_crypto::bls12381::ProofOfPossession;
//! use cedra_crypto_derive::{CryptoHasher, BCSCryptoHash};
