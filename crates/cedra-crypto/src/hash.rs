...
//! use the derive macros of `serde` and `cedra_crypto_derive` as follows:
//! ```
...
//!
//! ```
//! use cedra_crypto::hash::{CryptoHasher, TestOnlyHasher};
//!
...
pub(crate) const HASH_PREFIX: &[u8] = b"CEDRA::";
