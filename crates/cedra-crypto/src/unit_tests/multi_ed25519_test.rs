...
use crate::{
    ...
    test_utils::{TestCedraCrypto, TEST_SEED},
    traits::*,
...
static MESSAGE: Lazy<TestCedraCrypto> = Lazy::new(|| TestCedraCrypto("Test Message".to_string()));
fn message() -> &'static TestCedraCrypto {
    &MESSAGE
}
