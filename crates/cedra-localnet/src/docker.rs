...
const ERROR_MESSAGE: &str = "Docker is not available, confirm it is installed and running. See https://cedra.dev/guides/local-development-network#faq for assistance.";
