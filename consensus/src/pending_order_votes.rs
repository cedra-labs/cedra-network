...
use crate::counters;
use cedra_consensus_types::{common::Author, order_vote::OrderVote, quorum_cert::QuorumCert};
...
mod tests {
    ...
    use cedra_consensus_types::{order_vote::OrderVote, quorum_cert::QuorumCert};
