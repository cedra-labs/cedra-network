...
pub enum ValidatorTransaction {
    ...
    PricesStorageUpdate(PricesStorageUpdateTransaction),
}
...
impl ValidatorTransaction {
    pub fn type_str(&self) -> &'static str {
        match self {
            ...
            ValidatorTransaction::PricesStorageUpdate(_) => "validator_transaction__set_price",
        }
    }
    ...
    pub fn transaction_info(&self) -> &TransactionInfo {
        match self {
            ...
            ValidatorTransaction::PricesStorageUpdate(t) => &t.info,
        }
    }
    ...
    pub fn transaction_info_mut(&mut self) -> &mut TransactionInfo {
        match self {
            ...
            ValidatorTransaction::PricesStorageUpdate(t) => &mut t.info,
        }
    }
    ...
    pub fn timestamp(&self) -> U64 {
        match self {
            ...
            ValidatorTransaction::PricesStorageUpdate(t) => t.timestamp,
        }
    }
    ...
    pub fn events(&self) -> &[Event] {
        match self {
            ...
            ValidatorTransaction::PricesStorageUpdate(t) => &t.events,
        }
    }
}
    ...
    )> for ValidatorTransaction
{
    fn from(
        ...
        match txn {
            ...
            cedra_types::validator_txn::ValidatorTransaction::PricesStorageUpdate(price_info) => {
                Self::PricesStorageUpdate(PricesStorageUpdateTransaction {
                    info,
                    events,
                    timestamp: U64::from(timestamp),
...
#[derive(Clone, Debug, PartialEq, Eq, Serialize, Deserialize, Object)]
pub struct PricesStorageUpdateTransaction {
    #[serde(flatten)]
    #[oai(flatten)]
    pub info: TransactionInfo,
    pub events: Vec<Event>,
