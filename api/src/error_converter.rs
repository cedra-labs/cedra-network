...
use cedra_api_types::{mime_types::JSON, CedraError, CedraErrorCode};
use poem::{
...
/// be a JSON representation of CedraError. For our own code, this is exactly
...
fn build_error_response(error_string: String) -> Response {
    Json(CedraError::new_with_error_code(
        error_string,
