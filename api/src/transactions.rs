...
impl TransactionsApi {
    ...
    ///   1. Hash message bytes: "RawTransaction" bytes + BCS bytes of [Transaction](https://cedra-labs.github.io/cedra-network/cedra_types/transaction/enum.Transaction.html).
