...
use cedra_crypto::{x25519, ValidCryptoMaterialStringExt};
...
const MAINNET_SEED_PEERS: [(&str, &str, &str); 1] = [(
    ...
    "/dns/node1.cloud-b.mainnet.cedralabs.com/tcp/6182/noise-ik/0x003cc2ed36e7d486539ac2c411b48d962f1ef17d884c3a7109cad43f16bd5008/handshake/0",
)];
...
const TESTNET_SEED_PEERS: [(&str, &str, &str); 1] = [
    (
        ...
        "/ip4/t-seed.cedra.dev/tcp/6175/noise-ik/0x2f11b7c9fd7ced95ee9328b6027677e5a21ae259efed86bb6e02f88f8b695d33/handshake/0",
    ),
    // (
...
mod tests {
    ...
    use cedra_crypto::{Uniform, ValidCryptoMaterial};
    use cedra_types::{account_address::AccountAddress, waypoint::Waypoint};
    use rand::rngs::OsRng;
