...
const MULTISIG_ACCOUNT_DOMAIN_SEPARATOR: &[u8] = b"cedra_framework::multisig_account";
const STAKING_CONTRACT_DOMAIN_SEPARATOR: &[u8] = b"cedra_framework::staking_contract";
const VESTING_POOL_DOMAIN_SEPARATOR: &[u8] = b"cedra_framework::vesting";
...
// See this issue for potential improvements: https://github.com/cedra-labs/cedra-network/issues/3960
...
mod hasher {
    #[derive(serde::Deserialize, cedra_crypto_derive::CryptoHasher)]
