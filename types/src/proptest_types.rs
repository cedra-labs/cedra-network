...
use crate::{
    ...
    transaction::{
        block_epilogue::BlockEndInfo, ChangeSet, EntryFunction, ExecutionStatus, FaAddress,
...
impl CoinStoreResourceGen {
    pub fn materialize(self) -> CoinStoreResource<CedraCoinType> {
...
impl AccountStateGen {
    pub fn materialize(
        ...
        vec![
            ...
            (
                StateKey::resource_typed::<CoinStoreResource<CedraCoinType>>(address).unwrap(),
