...
pub enum FeatureFlag {
    ...
    PRIMARY_CEDRA_FUNGIBLE_STORE_AT_USER_ADDRESS = 61,
    OBJECT_NATIVE_DERIVED_ADDRESS = 62,
    DISPATCHABLE_FUNGIBLE_ASSET = 63,
    NEW_ACCOUNTS_DEFAULT_TO_FA_CEDRA_STORE = 64,
    OPERATIONS_DEFAULT_TO_FA_CEDRA_STORE = 65,
    ...
    /// AIP-105 (https://github.com/cedra-foundation/AIPs/blob/main/aips/aip-105.md)
    ...
    /// AIP-103 (https://github.com/cedra-foundation/AIPs/blob/main/aips/aip-103.md)
...
impl FeatureFlag {
    pub fn default_features() -> Vec<Self> {
        vec![
            ...
            FeatureFlag::CEDRA_STD_CHAIN_ID_NATIVES,
            ...
            FeatureFlag::CEDRA_UNIQUE_IDENTIFIERS,
...
pub fn cedra_test_feature_flags_genesis() -> ChangeSet {
