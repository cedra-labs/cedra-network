...
pub fn run_single_with_default_params(
    ...
    features.enable(FeatureFlag::NEW_ACCOUNTS_DEFAULT_TO_FA_CEDRA_STORE);
    features.enable(FeatureFlag::OPERATIONS_DEFAULT_TO_FA_CEDRA_STORE);
...
mod tests {
    ...
    fn test_compare_prod_and_another_all_types<E: VMBlockExecutor>(values_match: bool) {
        ...
        non_fa_features.disable(FeatureFlag::NEW_ACCOUNTS_DEFAULT_TO_FA_CEDRA_STORE);
        non_fa_features.disable(FeatureFlag::OPERATIONS_DEFAULT_TO_FA_CEDRA_STORE);
        ...
        fa_features.enable(FeatureFlag::NEW_ACCOUNTS_DEFAULT_TO_FA_CEDRA_STORE);
        fa_features.enable(FeatureFlag::OPERATIONS_DEFAULT_TO_FA_CEDRA_STORE);
