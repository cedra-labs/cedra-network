...
+ [`CedraTransport`] &mdash; A secure, reliable transport. It uses [NoiseIK] over
TCP to negotiate an encrypted and authenticated connection between peers.
The CedraNet version and any Cedra-specific application protocols are negotiated
afterward using the [CedraNet Handshake Protocol].
...
## How is this module organized?
    ...
    └── src
        ...
        │   └── wire               # Protocol for CedraNet handshakes and messaging
...
[`CedraNet Handshake Protocol`]: ../specifications/network/handshake-v1.md
[`ValidatorSet`]: ../types/src/on_chain_config/validator_set.rs
[`CedraTransport`]: ./src/transport/mod.rs
