...
struct TestHarness {
    ...
    peer_mgr_reqs_rx: cedra_channel::Receiver<(PeerId, ProtocolId), PeerManagerRequest>,
    peer_mgr_notifs_tx: cedra_channel::Sender<(PeerId, ProtocolId), ReceivedMessage>,
...
impl TestHarness {
    fn new_permissive(
        ...
        let (peer_mgr_reqs_tx, peer_mgr_reqs_rx) = cedra_channel::new(QueueStyle::FIFO, 1, None);
        let (connection_reqs_tx, connection_reqs_rx) =
            cedra_channel::new(QueueStyle::FIFO, 1, None);
