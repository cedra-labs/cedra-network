...
//! Convenience Network API for Cedra
...
/// Configuration needed for the client side of CedraNet applications
#[derive(Clone)]
...
/// Configuration needed for the service side of CedraNet applications
#[derive(Clone)]
pub struct NetworkServiceConfig {
    ...
    pub inbound_queue_config: cedra_channel::Config,
}
...
impl NetworkServiceConfig {
    pub fn new(
        direct_send_protocols_and_preferences: Vec<ProtocolId>,
        rpc_protocols_and_preferences: Vec<ProtocolId>,
        inbound_queue_config: cedra_channel::Config,
    ) -> Self {
        Self {
            direct_send_protocols_and_preferences,
            rpc_protocols_and_preferences,
...
/// Configuration needed for CedraNet applications to register with the network
...
pub trait NewNetworkEvents {
    fn new(
        peer_mgr_notifs_rx: cedra_channel::Receiver<(PeerId, ProtocolId), ReceivedMessage>,
...
/// a thin wrapper on `cedra_channel::Sender<(PeerId, ProtocolId), PeerManagerRequest>`,
