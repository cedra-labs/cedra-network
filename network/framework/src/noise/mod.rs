...
//! We use Noise to secure connections between peers in Cedra.
...
//!
//! ```
//! use cedra_network::noise::{AntiReplayTimestamps, HandshakeAuthMode, NoiseUpgrader};
//! use futures::{executor, future, io::{AsyncReadExt, AsyncWriteExt}};
//! use cedra_memsocket::MemorySocket;
//! use cedra_config::{config::{Peer, PeerRole}, network_id::{NetworkContext, NetworkId}};
//! use cedra_crypto::{x25519, ed25519, Uniform, PrivateKey, test_utils::TEST_SEED};
...
//! [crypto]: ../cedra_crypto/noise/index.html
