...
use cedra_channels::{self, cedra_channel};
...
pub struct PeerManagerRequestSender {
    inner: cedra_channel::Sender<(PeerId, ProtocolId), PeerManagerRequest>,
}
...
pub struct ConnectionRequestSender {
    inner: cedra_channel::Sender<PeerId, ConnectionRequest>,
}

impl PeerManagerRequestSender {
    /// Construct a new PeerManagerRequestSender with a raw channel::Sender
    pub fn new(inner: cedra_channel::Sender<(PeerId, ProtocolId), PeerManagerRequest>) -> Self {
        Self { inner }
    }
...
impl ConnectionRequestSender {
    /// Construct a new ConnectionRequestSender with a raw cedra_channel::Sender
    pub fn new(inner: cedra_channel::Sender<PeerId, ConnectionRequest>) -> Self {
        Self { inner }
    }
