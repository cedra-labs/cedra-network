...
use cedra_config::config::{Peer, PeerRole, PeerSet, HANDSHAKE_VERSION};
use cedra_crypto::{test_utils::TEST_SEED, traits::Uniform, x25519, x25519::PrivateKey};
use cedra_netcore::{
...
fn setup<TTransport>(
    ...
    Runtime,
    MockTimeService,
    (PeerId, CedraNetTransport<TTransport>),
    (PeerId, CedraNetTransport<TTransport>),
    ...
    TTransport::Listener: Send + 'static,
{
    ...
    let listener_transport = CedraNetTransport::new(
    ...
    let dialer_transport = CedraNetTransport::new(
        base_transport,
        dialer_network_context,
        time_service.clone(),
        dialer_key,
...
////////////////////////////////////////
// CedraNetTransport<MemoryTransport> //
////////////////////////////////////////
...
/////////////////////////////////////
// CedraNetTransport<TcpTransport> //
/////////////////////////////////////

#[test]
fn test_tcp_transport_mutual_auth() {
    test_transport_success(
        CEDRA_TCP_TRANSPORT.clone(),
        Auth::Mutual,
        "/ip4/127.0.0.1/tcp/0",
