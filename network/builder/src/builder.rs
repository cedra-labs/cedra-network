...
use cedra_event_notifications::{DbBackedOnChainConfig, EventSubscriptionService};
use cedra_logger::prelude::*;
use cedra_netcore::transport::tcp::TCPBufferCfg;
use cedra_network::{
...
use cedra_network_discovery::DiscoveryChangeListener;
use cedra_time_service::TimeService;
use cedra_types::{chain_id::ChainId, network_address::NetworkAddress};
...
impl NetworkBuilder {
    ...
    pub fn conn_mgr_reqs_tx(&self) -> Option<cedra_channels::Sender<ConnectivityRequest>> {
