...
use cedra_logger::{
    cedra_logger::FileWriter, info, telemetry_log_writer::TelemetryLog, LoggerFilterUpdater,
};
...
pub fn create_logger(
    ...
    let mut logger_builder = cedra_logger::Logger::builder();
...
fn log_config_and_build_information(node_config: &NodeConfig) {
    ...
    // with the features defined in the cedra-node Cargo.toml file.
