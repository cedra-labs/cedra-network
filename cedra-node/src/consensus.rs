...
use cedra_dkg_runtime::{start_dkg_runtime, DKGMessage};
...
fn create_consensus_publisher(
    ...
    let runtime = cedra_runtimes::spawn_named_runtime("publisher".into(), None);
...
fn create_observer_network_handler(
    ...
    let consensus_observer_runtime = cedra_runtimes::spawn_named_runtime("observer".into(), None);
