...
use cedra_config::{
    config::{CedraDataClientConfig, CedraDataMultiFetchConfig},
    network_id::{NetworkId, PeerNetworkId},
};
use cedra_storage_service_server::network::NetworkRequest;
use cedra_storage_service_types::{
    requests::DataRequest,
    responses::{CompleteDataRange, DataResponse, StorageServerSummary, StorageServiceResponse},
    StorageServiceError,
};
use cedra_types::transaction::TransactionListWithProof;
...
async fn all_bad_peers_with_invalid_responses() {
    ...
    for peer_priority in PeerPriority::get_all_ordered_priorities() {
        ...
        let data_client_config = CedraDataClientConfig {
            data_multi_fetch_config: CedraDataMultiFetchConfig {
...
fn verify_peer_states(client: &CedraDataClient, all_peers: HashSet<PeerNetworkId>) {
