...
use cedra_config::{
    config::{CedraDataClientConfig, CedraDataMultiFetchConfig, CedraLatencyFilteringConfig},
    network_id::{NetworkId, PeerNetworkId},
};
use cedra_storage_service_types::requests::{DataRequest, StorageServiceRequest};
...
async fn request_latency_filtering() {
    ...
    let data_client_config = CedraDataClientConfig {
        ...
        latency_filtering_config: CedraLatencyFilteringConfig {
