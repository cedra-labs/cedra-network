...
use cedra_storage_service_types::{responses::TransactionOrOutputListWithProof, Epoch};
use cedra_types::{
...
/// The API offered by the Cedra Data Client.
#[async_trait]
pub trait CedraDataClientInterface {
...
/// A response error that users of the Cedra Data Client can use to notify
