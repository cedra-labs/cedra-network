...
use cedra_storage_interface::{DbReader, LedgerSummary, Order};
use cedra_storage_service_notifications::StorageServiceNotifier;
...
impl MockClient {
    pub fn new(
        ...
        for network_id in network_ids.clone() {
            let queue_cfg = cedra_channel::Config::new(
...
mock! {
    ...
    impl DbReader for DatabaseReader {
        fn get_epoch_ending_ledger_infos(
            ...
            start_epoch: u64,
            end_epoch: u64,
        ) -> cedra_storage_interface::Result<EpochChangeProof>;
        ...
        fn get_transactions(
            ...
            fetch_events: bool,
        ) -> cedra_storage_interface::Result<TransactionListWithProof>;
        ...
        fn get_transaction_by_hash(
            ...
            ledger_version: Version,
            fetch_events: bool,
        ) -> cedra_storage_interface::Result<Option<TransactionWithProof>>;
        ...
        fn get_transaction_by_version(
            ...
            ledger_version: Version,
            fetch_events: bool,
        ) -> cedra_storage_interface::Result<TransactionWithProof>;

        fn get_first_txn_version(&self) -> cedra_storage_interface::Result<Option<Version>>;

        fn get_first_write_set_version(&self) -> cedra_storage_interface::Result<Option<Version>>;
        ...
        fn get_transaction_outputs(
            ...
            limit: u64,
            ledger_version: Version,
        ) -> cedra_storage_interface::Result<TransactionOutputListWithProof>;
        ...
        fn get_events(
            ...
            limit: u64,
            ledger_version: Version,
        ) -> cedra_storage_interface::Result<Vec<EventWithVersion>>;

        fn get_block_timestamp(&self, version: u64) -> cedra_storage_interface::Result<u64>;

        fn get_last_version_before_timestamp(
            &self,
            _timestamp: u64,
            _ledger_version: Version,
        ) -> cedra_storage_interface::Result<Version>;

        fn get_latest_ledger_info_option(&self) -> cedra_storage_interface::Result<Option<LedgerInfoWithSignatures>>;

        fn get_latest_ledger_info(&self) -> cedra_storage_interface::Result<LedgerInfoWithSignatures>;

        fn get_synced_version(&self) -> cedra_storage_interface::Result<Option<Version>>;

        fn get_latest_ledger_info_version(&self) -> cedra_storage_interface::Result<Version>;

        fn get_latest_commit_metadata(&self) -> cedra_storage_interface::Result<(Version, u64)>;
        ...
        fn get_account_ordered_transactions(
            ...
            include_events: bool,
            ledger_version: Version,
        ) -> cedra_storage_interface::Result<AccountOrderedTransactionsWithProof>;

        fn get_state_proof_with_ledger_info(
            &self,
            known_version: u64,
            ledger_info: LedgerInfoWithSignatures,
        ) -> cedra_storage_interface::Result<StateProof>;

        fn get_state_proof(&self, known_version: u64) -> cedra_storage_interface::Result<StateProof>;

        fn get_state_value_with_proof_by_version(
            &self,
            state_key: &StateKey,
            version: Version,
        ) -> cedra_storage_interface::Result<(Option<StateValue>, SparseMerkleProof)>;

        fn get_pre_committed_ledger_summary(&self) -> cedra_storage_interface::Result<LedgerSummary>;

        fn get_epoch_ending_ledger_info(&self, known_version: u64) ->cedra_storage_interface::Result<LedgerInfoWithSignatures>;

        fn get_accumulator_root_hash(&self, _version: Version) -> cedra_storage_interface::Result<HashValue>;

        fn get_accumulator_consistency_proof(
            &self,
            _client_known_version: Option<Version>,
            _ledger_version: Version,
        ) -> cedra_storage_interface::Result<AccumulatorConsistencyProof>;

        fn get_accumulator_summary(
            &self,
            ledger_version: Version,
        ) -> cedra_storage_interface::Result<TransactionAccumulatorSummary>;

        fn get_state_item_count(&self, version: Version) -> cedra_storage_interface::Result<usize>;
        ...
        fn get_state_value_chunk_with_proof(
            ...
            start_idx: usize,
            chunk_size: usize,
        ) -> cedra_storage_interface::Result<StateValueChunkWithProof>;

        fn get_epoch_snapshot_prune_window(&self) -> cedra_storage_interface::Result<usize>;

        fn is_state_merkle_pruner_enabled(&self) -> cedra_storage_interface::Result<bool>;
    }
}
