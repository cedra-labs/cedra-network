...
impl From<cedra_data_streaming_service::error::Error> for Error {
    fn from(error: cedra_data_streaming_service::error::Error) -> Self {
        Error::UnexpectedError(error.to_string())
    }
}

impl From<cedra_event_notifications::Error> for Error {
    fn from(error: cedra_event_notifications::Error) -> Self {
